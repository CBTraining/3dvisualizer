...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:xn,depthTest:!1,depthWrite:!1})}function mo(){return new yn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ea(),fragmentShader:`
...
`)+`
`+p);const S=y+d+a,b=y+p+o,N=Eo(s,s.VERTEX_SHADER,S),P=Eo(s,s.FRAGMENT_SHADER,b);s.attachShader(v,N),s.attachShader(v,P),e.index0AttributeName!==void 0?s.bindAttribLocation(v,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(v,0,"position"),s.linkProgram(v);function A(E){if(i.debug.checkShaderErrors){const V=s.getProgramInfoLog(v).trim(),B=s.getShaderInfoLog(N).trim(),q=s.getShaderInfoLog(P).trim();let Z=!0,G=!0;if(s.getProgramParameter(v,s.LINK_STATUS)===!1)if(Z=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,v,N,P);else{const j=bo(s,N,"vertex"),k=bo(s,P,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(v,s.VALIDATE_STATUS)+`
...
}`;function Up(i,t,e){let n=new ya;const s=new nt,r=new nt,a=new Zt,o=new Pp({depthPacking:bc}),l=new Lp,c={},h=e.maxTextureSize,u={[Mn]:Ae,[Ae]:Mn,[ce]:ce},f=new yn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new nt},radius:{value:4}},vertexShader:Dp,fragmentShader:Ip}),m=f.clone();m.defines.HORIZONTAL_PASS=1;const g=new ge;g.setAttribute("position",new Ke(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const v=new Ut(g,f),d=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Qo;let p=this.type;this.render=function(P,A,I){if(d.enabled===!1||d.autoUpdate===!1&&d.needsUpdate===!1||P.length===0)return;const $=i.getRenderTarget(),_=i.getActiveCubeFace(),E=i.getActiveMipmapLevel(),V=i.state;V.setBlending(xn),V.buffers.color.setClear(1,1,1,1),V.buffers.depth.setTest(!0),V.setScissorTest(!1);const B=p!==sn&&this.type===sn,q=p===sn&&this.type!==sn;for(let Z=0,G=P.length;Z<G;Z++){const j=P[Z],k=j.shadow;if(k===void 0){console.warn("THREE.WebGLShadowMap:",j,"has no shadow.");continue}if(k.autoUpdate===!1&&k.needsUpdate===!1)continue;s.copy(k.mapSize);const rt=k.getFrameExtents();if(s.multiply(rt),r.copy(k.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(r.x=Math.floor(h/rt.x),s.x=r.x*rt.x,k.mapSize.x=r.x),s.y>h&&(r.y=Math.floor(h/rt.y),s.y=r.y*rt.y,k.mapSize.y=r.y)),k.map===null||B===!0||q===!0){const W=this.type!==sn?{minFilter:Be,magFilter:Be}:{};k.map!==null&&k.map.dispose(),k.map=new Fn(s.x,s.y,W),k.map.texture.name=j.name+".shadowMap",k.camera.updateProjectionMatrix()}i.setRenderTarget(k.map),i.clear();const at=k.getViewportCount();for(let W=0;W<at;W++){const ut=k.getViewport(W);a.set(r.x*ut.x,r.y*ut.y,r.x*ut.z,r.y*ut.w),V.viewport(a),k.updateMatrices(j,W),n=k.getFrustum(),b(A,I,k.camera,j,this.type)}k.isPointLightShadow!==!0&&this.type===sn&&y(k,I),k.needsUpdate=!1}p=this.type,d.needsUpdate=!1,i.setRenderTarget($,_,E)};function y(P,A){const I=t.update(v);f.defines.VSM_SAMPLES!==P.blurSamples&&(f.defines.VSM_SAMPLES=P.blurSamples,m.defines.VSM_SAMPLES=P.blurSamples,f.needsUpdate=!0,m.needsUpdate=!0),P.mapPass===null&&(P.mapPass=new Fn(s.x,s.y)),f.uniforms.shadow_pass.value=P.map.texture,f.uniforms.resolution.value=P.mapSize,f.uniforms.radius.value=P.radius,i.setRenderTarget(P.mapPass),i.clear(),i.renderBufferDirect(A,null,I,f,v,null),m.uniforms.shadow_pass.value=P.mapPass.texture,m.uniforms.resolution.value=P.mapSize,m.uniforms.radius.value=P.radius,i.setRenderTarget(P.map),i.clear(),i.renderBufferDirect(A,null,I,m,v,null)}function S(P,A,I,$){let _=null;const E=I.isPointLight===!0?P.customDistanceMaterial:P.customDepthMaterial;if(E!==void 0)_=E;else if(_=I.isPointLight===!0?l:o,i.localClippingEnabled&&A.clipShadows===!0&&Array.isArray(A.clippingPlanes)&&A.clippingPlanes.length!==0||A.displacementMap&&A.displacementScale!==0||A.alphaMap&&A.alphaTest>0||A.map&&A.alphaTest>0){const V=_.uuid,B=A.uuid;let q=c[V];q===void 0&&(q={},c[V]=q);let Z=q[B];Z===void 0&&(Z=_.clone(),q[B]=Z,A.addEventListener("dispose",N)),_=Z}if(_.visible=A.visible,_.wireframe=A.wireframe,$===sn?_.side=A.shadowSide!==null?A.shadowSide:A.side:_.side=A.shadowSide!==null?A.shadowSide:u[A.side],_.alphaMap=A.alphaMap,_.alphaTest=A.alphaTest,_.map=A.map,_.clipShadows=A.clipShadows,_.clippingPlanes=A.clippingPlanes,_.clipIntersection=A.clipIntersection,_.displacementMap=A.displacementMap,_.displacementScale=A.displacementScale,_.displacementBias=A.displacementBias,_.wireframeLinewidth=A.wireframeLinewidth,_.linewidth=A.linewidth,I.isPointLight===!0&&_.isMeshDistanceMaterial===!0){const V=i.properties.get(_);V.light=I}return _}function b(P,A,I,$,_){if(P.visible===!1)return;if(P.layers.test(A.layers)&&(P.isMesh||P.isLine||P.isPoints)&&(P.castShadow||P.receiveShadow&&_===sn)&&(!P.frustumCulled||n.intersectsObject(P))){P.modelViewMatrix.multiplyMatrices(I.matrixWorldInverse,P.matrixWorld);const B=t.update(P),q=P.material;if(Array.isArray(q)){const Z=B.groups;for(let G=0,j=Z.length;G<j;G++){const k=Z[G],rt=q[k.materialIndex];if(rt&&rt.visible){const at=S(P,rt,$,_);P.onBeforeShadow(i,P,A,I,B,at,k),i.renderBufferDirect(I,null,B,at,P,k),P.onAfterShadow(i,P,A,I,B,at,k)}}}else if(q.visible){const Z=S(P,q,$,_);P.onBeforeShadow(i,P,A,I,B,Z,null),i.renderBufferDirect(I,null,B,Z,P,null),P.onAfterShadow(i,P,A,I,B,Z,null)}}const V=P.children;for(let B=0,q=V.length;B<q;B++)b(V[B],A,I,$,_)}function N(P){P.target.removeEventListener("dispose",N);for(const I in c){const $=c[I],_=P.target.uuid;_ in $&&($[_].dispose(),delete $[_])}}}const Np={[Ar]:Cr,[Rr]:Dr,[Pr]:Ir,[hi]:Lr,[Cr]:Ar,[Dr]:Rr,[Ir]:Pr,[Lr]:hi};function Fp(i){function t(){let R=!1;const ct=new Zt;let H=null;const K=new Zt(0,0,0,0);return{setMask:function(ot){H!==ot&&!R&&(i.colorMask(ot,ot,ot,ot),H=ot)},setLocked:function(ot){R=ot},setClear:function(ot,ht,kt,oe,ye){ye===!0&&(ot*=oe,ht*=oe,kt*=oe),ct.set(ot,ht,kt,oe),K.equals(ct)===!1&&(i.clearColor(ot,ht,kt,oe),K.copy(ct))},reset:function(){R=!1,H=null,K.set(-1,0,0,0)}}}function e(){let R=!1,ct=!1,H=null,K=null,ot=null;return{setReversed:function(ht){ct=ht},setTest:function(ht){ht?vt(i.DEPTH_TEST):dt(i.DEPTH_TEST)},setMask:function(ht){H!==ht&&!R&&(i.depthMask(ht),H=ht)},setFunc:function(ht){if(ct&&(ht=Np[ht]),K!==ht){switch(ht){case Ar:i.depthFunc(i.NEVER);break;case Cr:i.depthFunc(i.ALWAYS);break;case Rr:i.depthFunc(i.LESS);break;case hi:i.depthFunc(i.LEQUAL);break;case Pr:i.depthFunc(i.EQUAL);break;case Lr:i.depthFunc(i.GEQUAL);break;case Dr:i.depthFunc(i.GREATER);break;case Ir:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}K=ht}},setLocked:function(ht){R=ht},setClear:function(ht){ot!==ht&&(i.clearDepth(ht),ot=ht)},reset:function(){R=!1,H=null,K=null,ot=null}}}function n(){let R=!1,ct=null,H=null,K=null,ot=null,ht=null,kt=null,oe=null,ye=null;return{setTest:function(Vt){R||(Vt?vt(i.STENCIL_TEST):dt(i.STENCIL_TEST))},setMask:function(Vt){ct!==Vt&&!R&&(i.stencilMask(Vt),ct=Vt)},setFunc:function(Vt,Ee,Ze){(H!==Vt||K!==Ee||ot!==Ze)&&(i.stencilFunc(Vt,Ee,Ze),H=Vt,K=Ee,ot=Ze)},setOp:function(Vt,Ee,Ze){(ht!==Vt||kt!==Ee||oe!==Ze)&&(i.stencilOp(Vt,Ee,Ze),ht=Vt,kt=Ee,oe=Ze)},setLocked:function(Vt){R=Vt},setClear:function(Vt){ye!==Vt&&(i.clearStencil(Vt),ye=Vt)},reset:function(){R=!1,ct=null,H=null,K=null,ot=null,ht=null,kt=null,oe=null,ye=null}}}const s=new t,r=new e,a=new n,o=new WeakMap,l=new WeakMap;let c={},h={},u=new WeakMap,f=[],m=null,g=!1,v=null,d=null,p=null,y=null,S=null,b=null,N=null,P=new Ot(0,0,0),A=0,I=!1,$=null,_=null,E=null,V=null,B=null;const q=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let Z=!1,G=0;const j=i.getParameter(i.VERSION);j.indexOf("WebGL")!==-1?(G=parseFloat(/^WebGL (\d)/.exec(j)[1]),Z=G>=1):j.indexOf("OpenGL ES")!==-1&&(G=parseFloat(/^OpenGL ES (\d)/.exec(j)[1]),Z=G>=2);let k=null,rt={};const at=i.getParameter(i.SCISSOR_BOX),W=i.getParameter(i.VIEWPORT),ut=new Zt().fromArray(at),pt=new Zt().fromArray(W);function z(R,ct,H,K){const ot=new Uint8Array(4),ht=i.createTexture();i.bindTexture(R,ht),i.texParameteri(R,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(R,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let kt=0;kt<H;kt++)R===i.TEXTURE_3D||R===i.TEXTURE_2D_ARRAY?i.texImage3D(ct,0,i.RGBA,1,1,K,0,i.RGBA,i.UNSIGNED_BYTE,ot):i.texImage2D(ct+kt,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,ot);return ht}const Q={};Q[i.TEXTURE_2D]=z(i.TEXTURE_2D,i.TEXTURE_2D,1),Q[i.TEXTURE_CUBE_MAP]=z(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),Q[i.TEXTURE_2D_ARRAY]=z(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),Q[i.TEXTURE_3D]=z(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),r.setClear(1),a.setClear(0),vt(i.DEPTH_TEST),r.setFunc(hi),Nt(!1),Gt(Ba),vt(i.CULL_FACE),C(xn);function vt(R){c[R]!==!0&&(i.enable(R),c[R]=!0)}function dt(R){c[R]!==!1&&(i.disable(R),c[R]=!1)}function Pt(R,ct){return h[R]!==ct?(i.bindFramebuffer(R,ct),h[R]=ct,R===i.DRAW_FRAMEBUFFER&&(h[i.FRAMEBUFFER]=ct),R===i.FRAMEBUFFER&&(h[i.DRAW_FRAMEBUFFER]=ct),!0):!1}function bt(R,ct){let H=f,K=!1;if(R){H=u.get(ct),H===void 0&&(H=[],u.set(ct,H));const ot=R.textures;if(H.length!==ot.length||H[0]!==i.COLOR_ATTACHMENT0){for(let ht=0,kt=ot.length;ht<kt;ht++)H[ht]=i.COLOR_ATTACHMENT0+ht;H.length=ot.length,K=!0}}else H[0]!==i.BACK&&(H[0]=i.BACK,K=!0);K&&i.drawBuffers(H)}function Bt(R){return m!==R?(i.useProgram(R),m=R,!0):!1}const Kt={[Dn]:i.FUNC_ADD,[$l]:i.FUNC_SUBTRACT,[Jl]:i.FUNC_REVERSE_SUBTRACT};Kt[Ql]=i.MIN,Kt[tc]=i.MAX;const zt={[ec]:i.ZERO,[nc]:i.ONE,[ic]:i.SRC_COLOR,[wr]:i.SRC_ALPHA,[cc]:i.SRC_ALPHA_SATURATE,[oc]:i.DST_COLOR,[rc]:i.DST_ALPHA,[sc]:i.ONE_MINUS_SRC_COLOR,[Tr]:i.ONE_MINUS_SRC_ALPHA,[lc]:i.ONE_MINUS_DST_COLOR,[ac]:i.ONE_MINUS_DST_ALPHA,[hc]:i.CONSTANT_COLOR,[uc]:i.ONE_MINUS_CONSTANT_COLOR,[dc]:i.CONSTANT_ALPHA,[fc]:i.ONE_MINUS_CONSTANT_ALPHA};function C(R,ct,H,K,ot,ht,kt,oe,ye,Vt){if(R===xn){g===!0&&(dt(i.BLEND),g=!1);return}if(g===!1&&(vt(i.BLEND),g=!0),R!==Zl){if(R!==v||Vt!==I){if((d!==Dn||S!==Dn)&&(i.blendEquation(i.FUNC_ADD),d=Dn,S=Dn),Vt)switch(R){case oi:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case za:i.blendFunc(i.ONE,i.ONE);break;case ka:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Ga:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",R);break}else switch(R){case oi:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case za:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case ka:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Ga:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",R);break}p=null,y=null,b=null,N=null,P.set(0,0,0),A=0,v=R,I=Vt}return}ot=ot||ct,ht=ht||H,kt=kt||K,(ct!==d||ot!==S)&&(i.blendEquationSeparate(Kt[ct],Kt[ot]),d=ct,S=ot),(H!==p||K!==y||ht!==b||kt!==N)&&(i.blendFuncSeparate(zt[H],zt[K],zt[ht],zt[kt]),p=H,y=K,b=ht,N=kt),(oe.equals(P)===!1||ye!==A)&&(i.blendColor(oe.r,oe.g,oe.b,ye),P.copy(oe),A=ye),v=R,I=!1}function Ce(R,ct){R.side===ce?dt(i.CULL_FACE):vt(i.CULL_FACE);let H=R.side===Ae;ct&&(H=!H),Nt(H),R.blending===oi&&R.transparent===!1?C(xn):C(R.blending,R.blendEquation,R.blendSrc,R.blendDst,R.blendEquationAlpha,R.blendSrcAlpha,R.blendDstAlpha,R.blendColor,R.blendAlpha,R.premultipliedAlpha),r.setFunc(R.depthFunc),r.setTest(R.depthTest),r.setMask(R.depthWrite),s.setMask(R.colorWrite);const K=R.stencilWrite;a.setTest(K),K&&(a.setMask(R.stencilWriteMask),a.setFunc(R.stencilFunc,R.stencilRef,R.stencilFuncMask),a.setOp(R.stencilFail,R.stencilZFail,R.stencilZPass)),Qt(R.polygonOffset,R.polygonOffsetFactor,R.polygonOffsetUnits),R.alphaToCoverage===!0?vt(i.SAMPLE_ALPHA_TO_COVERAGE):dt(i.SAMPLE_ALPHA_TO_COVERAGE)}function Nt(R){$!==R&&(R?i.frontFace(i.CW):i.frontFace(i.CCW),$=R)}function Gt(R){R!==Kl?(vt(i.CULL_FACE),R!==_&&(R===Ba?i.cullFace(i.BACK):R===jl?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):dt(i.CULL_FACE),_=R}function Tt(R){R!==E&&(Z&&i.lineWidth(R),E=R)}function Qt(R,ct,H){R?(vt(i.POLYGON_OFFSET_FILL),(V!==ct||B!==H)&&(i.polygonOffset(ct,H),V=ct,B=H)):dt(i.POLYGON_OFFSET_FILL)}function Rt(R){R?vt(i.SCISSOR_TEST):dt(i.SCISSOR_TEST)}function w(R){R===void 0&&(R=i.TEXTURE0+q-1),k!==R&&(i.activeTexture(R),k=R)}function x(R,ct,H){H===void 0&&(k===null?H=i.TEXTURE0+q-1:H=k);let K=rt[H];K===void 0&&(K={type:void 0,texture:void 0},rt[H]=K),(K.type!==R||K.texture!==ct)&&(k!==H&&(i.activeTexture(H),k=H),i.bindTexture(R,ct||Q[R]),K.type=R,K.texture=ct)}function U(){const R=rt[k];R!==void 0&&R.type!==void 0&&(i.bindTexture(R.type,null),R.type=void 0,R.texture=void 0)}function Y(){try{i.compressedTexImage2D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function J(){try{i.compressedTexImage3D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function X(){try{i.texSubImage2D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function St(){try{i.texSubImage3D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function st(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function ft(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function Ht(){try{i.texStorage2D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function tt(){try{i.texStorage3D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function mt(){try{i.texImage2D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function At(){try{i.texImage3D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function Ct(R){ut.equals(R)===!1&&(i.scissor(R.x,R.y,R.z,R.w),ut.copy(R))}function gt(R){pt.equals(R)===!1&&(i.viewport(R.x,R.y,R.z,R.w),pt.copy(R))}function Ft(R,ct){let H=l.get(ct);H===void 0&&(H=new WeakMap,l.set(ct,H));let K=H.get(R);K===void 0&&(K=i.getUniformBlockIndex(ct,R.name),H.set(R,K))}function Lt(R,ct){const K=l.get(ct).get(R);o.get(ct)!==K&&(i.uniformBlockBinding(ct,K,R.__bindingPointIndex),o.set(ct,K))}function $t(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),c={},k=null,rt={},h={},u=new WeakMap,f=[],m=null,g=!1,v=null,d=null,p=null,y=null,S=null,b=null,N=null,P=new Ot(0,0,0),A=0,I=!1,$=null,_=null,E=null,V=null,B=null,ut.set(0,0,i.canvas.width,i.canvas.height),pt.set(0,0,i.canvas.width,i.canvas.height),s.reset(),r.reset(),a.reset()}return{buffers:{color:s,depth:r,stencil:a},enable:vt,disable:dt,bindFramebuffer:Pt,drawBuffers:bt,useProgram:Bt,setBlending:C,setMaterial:Ce,setFlipSided:Nt,setCullFace:Gt,setLineWidth:Tt,setPolygonOffset:Qt,setScissorTest:Rt,activeTexture:w,bindTexture:x,unbindTexture:U,compressedTexImage2D:Y,compressedTexImage3D:J,texImage2D:mt,texImage3D:At,updateUBOMapping:Ft,uniformBlockBinding:Lt,texStorage2D:Ht,texStorage3D:tt,texSubImage2D:X,texSubImage3D:St,compressedTexSubImage2D:st,compressedTexSubImage3D:ft,scissor:Ct,viewport:gt,reset:$t}}function Do(i,t,e,n){const s=Op(n);switch(e){case ol:return i*t;case cl:return i*t;case hl:return i*t*2;case ul:return i*t/s.components*s.byteLength;case _a:return i*t/s.components*s.byteLength;case dl:return i*t*2/s.components*s.byteLength;case va:return i*t*2/s.components*s.byteLength;case ll:return i*t*3/s.components*s.byteLength;case Xe:return i*t*4/s.components*s.byteLength;case xa:return i*t*4/s.components*s.byteLength;case ms:case gs:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*8;case _s:case vs:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*16;case Br:case kr:return Math.max(i,16)*Math.max(t,8)/4;case Or:case zr:return Math.max(i,8)*Math.max(t,8)/2;case Gr:case Hr:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*8;case Vr:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*16;case Wr:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*16;case Xr:return Math.floor((i+4)/5)*Math.floor((t+3)/4)*16;case qr:return Math.floor((i+4)/5)*Math.floor((t+4)/5)*16;case Yr:return Math.floor((i+5)/6)*Math.floor((t+4)/5)*16;case Kr:return Math.floor((i+5)/6)*Math.floor((t+5)/6)*16;case jr:return Math.floor((i+7)/8)*Math.floor((t+4)/5)*16;case Zr:return Math.floor((i+7)/8)*Math.floor((t+5)/6)*16;case $r:return Math.floor((i+7)/8)*Math.floor((t+7)/8)*16;case Jr:return Math.floor((i+9)/10)*Math.floor((t+4)/5)*16;case Qr:return Math.floor((i+9)/10)*Math.floor((t+5)/6)*16;case ta:return Math.floor((i+9)/10)*Math.floor((t+7)/8)*16;case ea:return Math.floor((i+9)/10)*Math.floor((t+9)/10)*16;case na:return Math.floor((i+11)/12)*Math.floor((t+9)/10)*16;case ia:return Math.floor((i+11)/12)*Math.floor((t+11)/12)*16;case xs:case sa:case ra:return Math.ceil(i/4)*Math.ceil(t/4)*16;case fl:case aa:return Math.ceil(i/4)*Math.ceil(t/4)*8;case oa:case la:return Math.ceil(i/4)*Math.ceil(t/4)*16}throw new Error(`Unable to determine texture byte length for ${e} format.`)}function Op(i){switch(i){case on:case sl:return{byteLength:1,components:1};case Di:case rl:case Fi:return{byteLength:2,components:1};case ma:case ga:return{byteLength:2,components:4};case Nn:case pa:case rn:return{byteLength:4,components:1};case al:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${i}.`)}function Bp(i,t,e,n,s,r,a){const o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new nt,h=new WeakMap;let u;const f=new WeakMap;let m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(w,x){return m?new OffscreenCanvas(w,x):Cs("canvas")}function v(w,x,U){let Y=1;const J=Rt(w);if((J.width>U||J.height>U)&&(Y=U/Math.max(J.width,J.height)),Y<1)if(typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&w instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&w instanceof ImageBitmap||typeof VideoFrame<"u"&&w instanceof VideoFrame){const X=Math.floor(Y*J.width),St=Math.floor(Y*J.height);u===void 0&&(u=g(X,St));const st=x?g(X,St):u;return st.width=X,st.height=St,st.getContext("2d").drawImage(w,0,0,X,St),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+J.width+"x"+J.height+") to ("+X+"x"+St+")."),st}else return"data"in w&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+J.width+"x"+J.height+")."),w;return w}function d(w){return w.generateMipmaps&&w.minFilter!==Be&&w.minFilter!==Oe}function p(w){i.generateMipmap(w)}function y(w,x,U,Y,J=!1){if(w!==null){if(i[w]!==void 0)return i[w];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+w+"'")}let X=x;if(x===i.RED&&(U===i.FLOAT&&(X=i.R32F),U===i.HALF_FLOAT&&(X=i.R16F),U===i.UNSIGNED_BYTE&&(X=i.R8)),x===i.RED_INTEGER&&(U===i.UNSIGNED_BYTE&&(X=i.R8UI),U===i.UNSIGNED_SHORT&&(X=i.R16UI),U===i.UNSIGNED_INT&&(X=i.R32UI),U===i.BYTE&&(X=i.R8I),U===i.SHORT&&(X=i.R16I),U===i.INT&&(X=i.R32I)),x===i.RG&&(U===i.FLOAT&&(X=i.RG32F),U===i.HALF_FLOAT&&(X=i.RG16F),U===i.UNSIGNED_BYTE&&(X=i.RG8)),x===i.RG_INTEGER&&(U===i.UNSIGNED_BYTE&&(X=i.RG8UI),U===i.UNSIGNED_SHORT&&(X=i.RG16UI),U===i.UNSIGNED_INT&&(X=i.RG32UI),U===i.BYTE&&(X=i.RG8I),U===i.SHORT&&(X=i.RG16I),U===i.INT&&(X=i.RG32I)),x===i.RGB_INTEGER&&(U===i.UNSIGNED_BYTE&&(X=i.RGB8UI),U===i.UNSIGNED_SHORT&&(X=i.RGB16UI),U===i.UNSIGNED_INT&&(X=i.RGB32UI),U===i.BYTE&&(X=i.RGB8I),U===i.SHORT&&(X=i.RGB16I),U===i.INT&&(X=i.RGB32I)),x===i.RGBA_INTEGER&&(U===i.UNSIGNED_BYTE&&(X=i.RGBA8UI),U===i.UNSIGNED_SHORT&&(X=i.RGBA16UI),U===i.UNSIGNED_INT&&(X=i.RGBA32UI),U===i.BYTE&&(X=i.RGBA8I),U===i.SHORT&&(X=i.RGBA16I),U===i.INT&&(X=i.RGBA32I)),x===i.RGB&&U===i.UNSIGNED_INT_5_9_9_9_REV&&(X=i.RGB9_E5),x===i.RGBA){const St=J?Es:qt.getTransfer(Y);U===i.FLOAT&&(X=i.RGBA32F),U===i.HALF_FLOAT&&(X=i.RGBA16F),U===i.UNSIGNED_BYTE&&(X=St===ee?i.SRGB8_ALPHA8:i.RGBA8),U===i.UNSIGNED_SHORT_4_4_4_4&&(X=i.RGBA4),U===i.UNSIGNED_SHORT_5_5_5_1&&(X=i.RGB5_A1)}return(X===i.R16F||X===i.R32F||X===i.RG16F||X===i.RG32F||X===i.RGBA16F||X===i.RGBA32F)&&t.get("EXT_color_buffer_float"),X}function S(w,x){let U;return w?x===null||x===Nn||x===fi?U=i.DEPTH24_STENCIL8:x===rn?U=i.DEPTH32F_STENCIL8:x===Di&&(U=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):x===null||x===Nn||x===fi?U=i.DEPTH_COMPONENT24:x===rn?U=i.DEPTH_COMPONENT32F:x===Di&&(U=i.DEPTH_COMPONENT16),U}function b(w,x){return d(w)===!0||w.isFramebufferTexture&&w.minFilter!==Be&&w.minFilter!==Oe?Math.log2(Math.max(x.width,x.height))+1:w.mipmaps!==void 0&&w.mipmaps.length>0?w.mipmaps.length:w.isCompressedTexture&&Array.isArray(w.image)?x.mipmaps.length:1}function N(w){const x=w.target;x.removeEventListener("dispose",N),A(x),x.isVideoTexture&&h.delete(x)}function P(w){const x=w.target;x.removeEventListener("dispose",P),$(x)}function A(w){const x=n.get(w);if(x.__webglInit===void 0)return;const U=w.source,Y=f.get(U);if(Y){const J=Y[x.__cacheKey];J.usedTimes--,J.usedTimes===0&&I(w),Object.keys(Y).length===0&&f.delete(U)}n.remove(w)}function I(w){const x=n.get(w);i.deleteTexture(x.__webglTexture);const U=w.source,Y=f.get(U);delete Y[x.__cacheKey],a.memory.textures--}function $(w){const x=n.get(w);if(w.depthTexture&&w.depthTexture.dispose(),w.isWebGLCubeRenderTarget)for(let Y=0;Y<6;Y++){if(Array.isArray(x.__webglFramebuffer[Y]))for(let J=0;J<x.__webglFramebuffer[Y].length;J++)i.deleteFramebuffer(x.__webglFramebuffer[Y][J]);else i.deleteFramebuffer(x.__webglFramebuffer[Y]);x.__webglDepthbuffer&&i.deleteRenderbuffer(x.__webglDepthbuffer[Y])}else{if(Array.isArray(x.__webglFramebuffer))for(let Y=0;Y<x.__webglFramebuffer.length;Y++)i.deleteFramebuffer(x.__webglFramebuffer[Y]);else i.deleteFramebuffer(x.__webglFramebuffer);if(x.__webglDepthbuffer&&i.deleteRenderbuffer(x.__webglDepthbuffer),x.__webglMultisampledFramebuffer&&i.deleteFramebuffer(x.__webglMultisampledFramebuffer),x.__webglColorRenderbuffer)for(let Y=0;Y<x.__webglColorRenderbuffer.length;Y++)x.__webglColorRenderbuffer[Y]&&i.deleteRenderbuffer(x.__webglColorRenderbuffer[Y]);x.__webglDepthRenderbuffer&&i.deleteRenderbuffer(x.__webglDepthRenderbuffer)}const U=w.textures;for(let Y=0,J=U.length;Y<J;Y++){const X=n.get(U[Y]);X.__webglTexture&&(i.deleteTexture(X.__webglTexture),a.memory.textures--),n.remove(U[Y])}n.remove(w)}let _=0;function E(){_=0}function V(){const w=_;return w>=s.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+w+" texture units while this GPU supports only "+s.maxTextures),_+=1,w}function B(w){const x=[];return x.push(w.wrapS),x.push(w.wrapT),x.push(w.wrapR||0),x.push(w.magFilter),x.push(w.minFilter),x.push(w.anisotropy),x.push(w.internalFormat),x.push(w.format),x.push(w.type),x.push(w.generateMipmaps),x.push(w.premultiplyAlpha),x.push(w.flipY),x.push(w.unpackAlignment),x.push(w.colorSpace),x.join()}function q(w,x){const U=n.get(w);if(w.isVideoTexture&&Tt(w),w.isRenderTargetTexture===!1&&w.version>0&&U.__version!==w.version){const Y=w.image;if(Y===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(Y.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{pt(U,w,x);return}}e.bindTexture(i.TEXTURE_2D,U.__webglTexture,i.TEXTURE0+x)}function Z(w,x){const U=n.get(w);if(w.version>0&&U.__version!==w.version){pt(U,w,x);return}e.bindTexture(i.TEXTURE_2D_ARRAY,U.__webglTexture,i.TEXTURE0+x)}function G(w,x){const U=n.get(w);if(w.version>0&&U.__version!==w.version){pt(U,w,x);return}e.bindTexture(i.TEXTURE_3D,U.__webglTexture,i.TEXTURE0+x)}function j(w,x){const U=n.get(w);if(w.version>0&&U.__version!==w.version){z(U,w,x);return}e.bindTexture(i.TEXTURE_CUBE_MAP,U.__webglTexture,i.TEXTURE0+x)}const k={[Li]:i.REPEAT,[Un]:i.CLAMP_TO_EDGE,[Fr]:i.MIRRORED_REPEAT},rt={[Be]:i.NEAREST,[yc]:i.NEAREST_MIPMAP_NEAREST,[Hi]:i.NEAREST_MIPMAP_LINEAR,[Oe]:i.LINEAR,[Gs]:i.LINEAR_MIPMAP_NEAREST,[vn]:i.LINEAR_MIPMAP_LINEAR},at={[Tc]:i.NEVER,[Dc]:i.ALWAYS,[Ac]:i.LESS,[ml]:i.LEQUAL,[Cc]:i.EQUAL,[Lc]:i.GEQUAL,[Rc]:i.GREATER,[Pc]:i.NOTEQUAL};function W(w,x){if(x.type===rn&&t.has("OES_texture_float_linear")===!1&&(x.magFilter===Oe||x.magFilter===Gs||x.magFilter===Hi||x.magFilter===vn||x.minFilter===Oe||x.minFilter===Gs||x.minFilter===Hi||x.minFilter===vn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(w,i.TEXTURE_WRAP_S,k[x.wrapS]),i.texParameteri(w,i.TEXTURE_WRAP_T,k[x.wrapT]),(w===i.TEXTURE_3D||w===i.TEXTURE_2D_ARRAY)&&i.texParameteri(w,i.TEXTURE_WRAP_R,k[x.wrapR]),i.texParameteri(w,i.TEXTURE_MAG_FILTER,rt[x.magFilter]),i.texParameteri(w,i.TEXTURE_MIN_FILTER,rt[x.minFilter]),x.compareFunction&&(i.texParameteri(w,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(w,i.TEXTURE_COMPARE_FUNC,at[x.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(x.magFilter===Be||x.minFilter!==Hi&&x.minFilter!==vn||x.type===rn&&t.has("OES_texture_float_linear")===!1)return;if(x.anisotropy>1||n.get(x).__currentAnisotropy){const U=t.get("EXT_texture_filter_anisotropic");i.texParameterf(w,U.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(x.anisotropy,s.getMaxAnisotropy())),n.get(x).__currentAnisotropy=x.anisotropy}}}function ut(w,x){let U=!1;w.__webglInit===void 0&&(w.__webglInit=!0,x.addEventListener("dispose",N));const Y=x.source;let J=f.get(Y);J===void 0&&(J={},f.set(Y,J));const X=B(x);if(X!==w.__cacheKey){J[X]===void 0&&(J[X]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,U=!0),J[X].usedTimes++;const St=J[w.__cacheKey];St!==void 0&&(J[w.__cacheKey].usedTimes--,St.usedTimes===0&&I(x)),w.__cacheKey=X,w.__webglTexture=J[X].texture}return U}function pt(w,x,U){let Y=i.TEXTURE_2D;(x.isDataArrayTexture||x.isCompressedArrayTexture)&&(Y=i.TEXTURE_2D_ARRAY),x.isData3DTexture&&(Y=i.TEXTURE_3D);const J=ut(w,x),X=x.source;e.bindTexture(Y,w.__webglTexture,i.TEXTURE0+U);const St=n.get(X);if(X.version!==St.__version||J===!0){e.activeTexture(i.TEXTURE0+U);const st=qt.getPrimaries(qt.workingColorSpace),ft=x.colorSpace===_n?null:qt.getPrimaries(x.colorSpace),Ht=x.colorSpace===_n||st===ft?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,x.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,x.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ht);let tt=v(x.image,!1,s.maxTextureSize);tt=Qt(x,tt);const mt=r.convert(x.format,x.colorSpace),At=r.convert(x.type);let Ct=y(x.internalFormat,mt,At,x.colorSpace,x.isVideoTexture);W(Y,x);let gt;const Ft=x.mipmaps,Lt=x.isVideoTexture!==!0,$t=St.__version===void 0||J===!0,R=X.dataReady,ct=b(x,tt);if(x.isDepthTexture)Ct=S(x.format===pi,x.type),$t&&(Lt?e.texStorage2D(i.TEXTURE_2D,1,Ct,tt.width,tt.height):e.texImage2D(i.TEXTURE_2D,0,Ct,tt.width,tt.height,0,mt,At,null));else if(x.isDataTexture)if(Ft.length>0){Lt&&$t&&e.texStorage2D(i.TEXTURE_2D,ct,Ct,Ft[0].width,Ft[0].height);for(let H=0,K=Ft.length;H<K;H++)gt=Ft[H],Lt?R&&e.texSubImage2D(i.TEXTURE_2D,H,0,0,gt.width,gt.height,mt,At,gt.data):e.texImage2D(i.TEXTURE_2D,H,Ct,gt.width,gt.height,0,mt,At,gt.data);x.generateMipmaps=!1}else Lt?($t&&e.texStorage2D(i.TEXTURE_2D,ct,Ct,tt.width,tt.height),R&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,tt.width,tt.height,mt,At,tt.data)):e.texImage2D(i.TEXTURE_2D,0,Ct,tt.width,tt.height,0,mt,At,tt.data);else if(x.isCompressedTexture)if(x.isCompressedArrayTexture){Lt&&$t&&e.texStorage3D(i.TEXTURE_2D_ARRAY,ct,Ct,Ft[0].width,Ft[0].height,tt.depth);for(let H=0,K=Ft.length;H<K;H++)if(gt=Ft[H],x.format!==Xe)if(mt!==null)if(Lt){if(R)if(x.layerUpdates.size>0){const ot=Do(gt.width,gt.height,x.format,x.type);for(const ht of x.layerUpdates){const kt=gt.data.subarray(ht*ot/gt.data.BYTES_PER_ELEMENT,(ht+1)*ot/gt.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,H,0,0,ht,gt.width,gt.height,1,mt,kt,0,0)}x.clearLayerUpdates()}else e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,H,0,0,0,gt.width,gt.height,tt.depth,mt,gt.data,0,0)}else e.compressedTexImage3D(i.TEXTURE_2D_ARRAY,H,Ct,gt.width,gt.height,tt.depth,0,gt.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Lt?R&&e.texSubImage3D(i.TEXTURE_2D_ARRAY,H,0,0,0,gt.width,gt.height,tt.depth,mt,At,gt.data):e.texImage3D(i.TEXTURE_2D_ARRAY,H,Ct,gt.width,gt.height,tt.depth,0,mt,At,gt.data)}else{Lt&&$t&&e.texStorage2D(i.TEXTURE_2D,ct,Ct,Ft[0].width,Ft[0].height);for(let H=0,K=Ft.length;H<K;H++)gt=Ft[H],x.format!==Xe?mt!==null?Lt?R&&e.compressedTexSubImage2D(i.TEXTURE_2D,H,0,0,gt.width,gt.height,mt,gt.data):e.compressedTexImage2D(i.TEXTURE_2D,H,Ct,gt.width,gt.height,0,gt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Lt?R&&e.texSubImage2D(i.TEXTURE_2D,H,0,0,gt.width,gt.height,mt,At,gt.data):e.texImage2D(i.TEXTURE_2D,H,Ct,gt.width,gt.height,0,mt,At,gt.data)}else if(x.isDataArrayTexture)if(Lt){if($t&&e.texStorage3D(i.TEXTURE_2D_ARRAY,ct,Ct,tt.width,tt.height,tt.depth),R)if(x.layerUpdates.size>0){const H=Do(tt.width,tt.height,x.format,x.type);for(const K of x.layerUpdates){const ot=tt.data.subarray(K*H/tt.data.BYTES_PER_ELEMENT,(K+1)*H/tt.data.BYTES_PER_ELEMENT);e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,K,tt.width,tt.height,1,mt,At,ot)}x.clearLayerUpdates()}else e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,tt.width,tt.height,tt.depth,mt,At,tt.data)}else e.texImage3D(i.TEXTURE_2D_ARRAY,0,Ct,tt.width,tt.height,tt.depth,0,mt,At,tt.data);else if(x.isData3DTexture)Lt?($t&&e.texStorage3D(i.TEXTURE_3D,ct,Ct,tt.width,tt.height,tt.depth),R&&e.texSubImage3D(i.TEXTURE_3D,0,0,0,0,tt.width,tt.height,tt.depth,mt,At,tt.data)):e.texImage3D(i.TEXTURE_3D,0,Ct,tt.width,tt.height,tt.depth,0,mt,At,tt.data);else if(x.isFramebufferTexture){if($t)if(Lt)e.texStorage2D(i.TEXTURE_2D,ct,Ct,tt.width,tt.height);else{let H=tt.width,K=tt.height;for(let ot=0;ot<ct;ot++)e.texImage2D(i.TEXTURE_2D,ot,Ct,H,K,0,mt,At,null),H>>=1,K>>=1}}else if(Ft.length>0){if(Lt&&$t){const H=Rt(Ft[0]);e.texStorage2D(i.TEXTURE_2D,ct,Ct,H.width,H.height)}for(let H=0,K=Ft.length;H<K;H++)gt=Ft[H],Lt?R&&e.texSubImage2D(i.TEXTURE_2D,H,0,0,mt,At,gt):e.texImage2D(i.TEXTURE_2D,H,Ct,mt,At,gt);x.generateMipmaps=!1}else if(Lt){if($t){const H=Rt(tt);e.texStorage2D(i.TEXTURE_2D,ct,Ct,H.width,H.height)}R&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,mt,At,tt)}else e.texImage2D(i.TEXTURE_2D,0,Ct,mt,At,tt);d(x)&&p(Y),St.__version=X.version,x.onUpdate&&x.onUpdate(x)}w.__version=x.version}function z(w,x,U){if(x.image.length!==6)return;const Y=ut(w,x),J=x.source;e.bindTexture(i.TEXTURE_CUBE_MAP,w.__webglTexture,i.TEXTURE0+U);const X=n.get(J);if(J.version!==X.__version||Y===!0){e.activeTexture(i.TEXTURE0+U);const St=qt.getPrimaries(qt.workingColorSpace),st=x.colorSpace===_n?null:qt.getPrimaries(x.colorSpace),ft=x.colorSpace===_n||St===st?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,x.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,x.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,ft);const Ht=x.isCompressedTexture||x.image[0].isCompressedTexture,tt=x.image[0]&&x.image[0].isDataTexture,mt=[];for(let K=0;K<6;K++)!Ht&&!tt?mt[K]=v(x.image[K],!0,s.maxCubemapSize):mt[K]=tt?x.image[K].image:x.image[K],mt[K]=Qt(x,mt[K]);const At=mt[0],Ct=r.convert(x.format,x.colorSpace),gt=r.convert(x.type),Ft=y(x.internalFormat,Ct,gt,x.colorSpace),Lt=x.isVideoTexture!==!0,$t=X.__version===void 0||Y===!0,R=J.dataReady;let ct=b(x,At);W(i.TEXTURE_CUBE_MAP,x);let H;if(Ht){Lt&&$t&&e.texStorage2D(i.TEXTURE_CUBE_MAP,ct,Ft,At.width,At.height);for(let K=0;K<6;K++){H=mt[K].mipmaps;for(let ot=0;ot<H.length;ot++){const ht=H[ot];x.format!==Xe?Ct!==null?Lt?R&&e.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ot,0,0,ht.width,ht.height,Ct,ht.data):e.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ot,Ft,ht.width,ht.height,0,ht.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Lt?R&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ot,0,0,ht.width,ht.height,Ct,gt,ht.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ot,Ft,ht.width,ht.height,0,Ct,gt,ht.data)}}}else{if(H=x.mipmaps,Lt&&$t){H.length>0&&ct++;const K=Rt(mt[0]);e.texStorage2D(i.TEXTURE_CUBE_MAP,ct,Ft,K.width,K.height)}for(let K=0;K<6;K++)if(tt){Lt?R&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,mt[K].width,mt[K].height,Ct,gt,mt[K].data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,Ft,mt[K].width,mt[K].height,0,Ct,gt,mt[K].data);for(let ot=0;ot<H.length;ot++){const kt=H[ot].image[K].image;Lt?R&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ot+1,0,0,kt.width,kt.height,Ct,gt,kt.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ot+1,Ft,kt.width,kt.height,0,Ct,gt,kt.data)}}else{Lt?R&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,Ct,gt,mt[K]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,Ft,Ct,gt,mt[K]);for(let ot=0;ot<H.length;ot++){const ht=H[ot];Lt?R&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ot+1,0,0,Ct,gt,ht.image[K]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ot+1,Ft,Ct,gt,ht.image[K])}}}d(x)&&p(i.TEXTURE_CUBE_MAP),X.__version=J.version,x.onUpdate&&x.onUpdate(x)}w.__version=x.version}function Q(w,x,U,Y,J,X){const St=r.convert(U.format,U.colorSpace),st=r.convert(U.type),ft=y(U.internalFormat,St,st,U.colorSpace);if(!n.get(x).__hasExternalTextures){const tt=Math.max(1,x.width>>X),mt=Math.max(1,x.height>>X);J===i.TEXTURE_3D||J===i.TEXTURE_2D_ARRAY?e.texImage3D(J,X,ft,tt,mt,x.depth,0,St,st,null):e.texImage2D(J,X,ft,tt,mt,0,St,st,null)}e.bindFramebuffer(i.FRAMEBUFFER,w),Gt(x)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Y,J,n.get(U).__webglTexture,0,Nt(x)):(J===i.TEXTURE_2D||J>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&J<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,Y,J,n.get(U).__webglTexture,X),e.bindFramebuffer(i.FRAMEBUFFER,null)}function vt(w,x,U){if(i.bindRenderbuffer(i.RENDERBUFFER,w),x.depthBuffer){const Y=x.depthTexture,J=Y&&Y.isDepthTexture?Y.type:null,X=S(x.stencilBuffer,J),St=x.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,st=Nt(x);Gt(x)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,st,X,x.width,x.height):U?i.renderbufferStorageMultisample(i.RENDERBUFFER,st,X,x.width,x.height):i.renderbufferStorage(i.RENDERBUFFER,X,x.width,x.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,St,i.RENDERBUFFER,w)}else{const Y=x.textures;for(let J=0;J<Y.length;J++){const X=Y[J],St=r.convert(X.format,X.colorSpace),st=r.convert(X.type),ft=y(X.internalFormat,St,st,X.colorSpace),Ht=Nt(x);U&&Gt(x)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,Ht,ft,x.width,x.height):Gt(x)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Ht,ft,x.width,x.height):i.renderbufferStorage(i.RENDERBUFFER,ft,x.width,x.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function dt(w,x){if(x&&x.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(i.FRAMEBUFFER,w),!(x.depthTexture&&x.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!n.get(x.depthTexture).__webglTexture||x.depthTexture.image.width!==x.width||x.depthTexture.image.height!==x.height)&&(x.depthTexture.image.width=x.width,x.depthTexture.image.height=x.height,x.depthTexture.needsUpdate=!0),q(x.depthTexture,0);const Y=n.get(x.depthTexture).__webglTexture,J=Nt(x);if(x.depthTexture.format===li)Gt(x)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,Y,0,J):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,Y,0);else if(x.depthTexture.format===pi)Gt(x)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,Y,0,J):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,Y,0);else throw new Error("Unknown depthTexture format")}function Pt(w){const x=n.get(w),U=w.isWebGLCubeRenderTarget===!0;if(x.__boundDepthTexture!==w.depthTexture){const Y=w.depthTexture;if(x.__depthDisposeCallback&&x.__depthDisposeCallback(),Y){const J=()=>{delete x.__boundDepthTexture,delete x.__depthDisposeCallback,Y.removeEventListener("dispose",J)};Y.addEventListener("dispose",J),x.__depthDisposeCallback=J}x.__boundDepthTexture=Y}if(w.depthTexture&&!x.__autoAllocateDepthBuffer){if(U)throw new Error("target.depthTexture not supported in Cube render targets");dt(x.__webglFramebuffer,w)}else if(U){x.__webglDepthbuffer=[];for(let Y=0;Y<6;Y++)if(e.bindFramebuffer(i.FRAMEBUFFER,x.__webglFramebuffer[Y]),x.__webglDepthbuffer[Y]===void 0)x.__webglDepthbuffer[Y]=i.createRenderbuffer(),vt(x.__webglDepthbuffer[Y],w,!1);else{const J=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,X=x.__webglDepthbuffer[Y];i.bindRenderbuffer(i.RENDERBUFFER,X),i.framebufferRenderbuffer(i.FRAMEBUFFER,J,i.RENDERBUFFER,X)}}else if(e.bindFramebuffer(i.FRAMEBUFFER,x.__webglFramebuffer),x.__webglDepthbuffer===void 0)x.__webglDepthbuffer=i.createRenderbuffer(),vt(x.__webglDepthbuffer,w,!1);else{const Y=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,J=x.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,J),i.framebufferRenderbuffer(i.FRAMEBUFFER,Y,i.RENDERBUFFER,J)}e.bindFramebuffer(i.FRAMEBUFFER,null)}function bt(w,x,U){const Y=n.get(w);x!==void 0&&Q(Y.__webglFramebuffer,w,w.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),U!==void 0&&Pt(w)}function Bt(w){const x=w.texture,U=n.get(w),Y=n.get(x);w.addEventListener("dispose",P);const J=w.textures,X=w.isWebGLCubeRenderTarget===!0,St=J.length>1;if(St||(Y.__webglTexture===void 0&&(Y.__webglTexture=i.createTexture()),Y.__version=x.version,a.memory.textures++),X){U.__webglFramebuffer=[];for(let st=0;st<6;st++)if(x.mipmaps&&x.mipmaps.length>0){U.__webglFramebuffer[st]=[];for(let ft=0;ft<x.mipmaps.length;ft++)U.__webglFramebuffer[st][ft]=i.createFramebuffer()}else U.__webglFramebuffer[st]=i.createFramebuffer()}else{if(x.mipmaps&&x.mipmaps.length>0){U.__webglFramebuffer=[];for(let st=0;st<x.mipmaps.length;st++)U.__webglFramebuffer[st]=i.createFramebuffer()}else U.__webglFramebuffer=i.createFramebuffer();if(St)for(let st=0,ft=J.length;st<ft;st++){const Ht=n.get(J[st]);Ht.__webglTexture===void 0&&(Ht.__webglTexture=i.createTexture(),a.memory.textures++)}if(w.samples>0&&Gt(w)===!1){U.__webglMultisampledFramebuffer=i.createFramebuffer(),U.__webglColorRenderbuffer=[],e.bindFramebuffer(i.FRAMEBUFFER,U.__webglMultisampledFramebuffer);for(let st=0;st<J.length;st++){const ft=J[st];U.__webglColorRenderbuffer[st]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,U.__webglColorRenderbuffer[st]);const Ht=r.convert(ft.format,ft.colorSpace),tt=r.convert(ft.type),mt=y(ft.internalFormat,Ht,tt,ft.colorSpace,w.isXRRenderTarget===!0),At=Nt(w);i.renderbufferStorageMultisample(i.RENDERBUFFER,At,mt,w.width,w.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+st,i.RENDERBUFFER,U.__webglColorRenderbuffer[st])}i.bindRenderbuffer(i.RENDERBUFFER,null),w.depthBuffer&&(U.__webglDepthRenderbuffer=i.createRenderbuffer(),vt(U.__webglDepthRenderbuffer,w,!0)),e.bindFramebuffer(i.FRAMEBUFFER,null)}}if(X){e.bindTexture(i.TEXTURE_CUBE_MAP,Y.__webglTexture),W(i.TEXTURE_CUBE_MAP,x);for(let st=0;st<6;st++)if(x.mipmaps&&x.mipmaps.length>0)for(let ft=0;ft<x.mipmaps.length;ft++)Q(U.__webglFramebuffer[st][ft],w,x,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+st,ft);else Q(U.__webglFramebuffer[st],w,x,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+st,0);d(x)&&p(i.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(St){for(let st=0,ft=J.length;st<ft;st++){const Ht=J[st],tt=n.get(Ht);e.bindTexture(i.TEXTURE_2D,tt.__webglTexture),W(i.TEXTURE_2D,Ht),Q(U.__webglFramebuffer,w,Ht,i.COLOR_ATTACHMENT0+st,i.TEXTURE_2D,0),d(Ht)&&p(i.TEXTURE_2D)}e.unbindTexture()}else{let st=i.TEXTURE_2D;if((w.isWebGL3DRenderTarget||w.isWebGLArrayRenderTarget)&&(st=w.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(st,Y.__webglTexture),W(st,x),x.mipmaps&&x.mipmaps.length>0)for(let ft=0;ft<x.mipmaps.length;ft++)Q(U.__webglFramebuffer[ft],w,x,i.COLOR_ATTACHMENT0,st,ft);else Q(U.__webglFramebuffer,w,x,i.COLOR_ATTACHMENT0,st,0);d(x)&&p(st),e.unbindTexture()}w.depthBuffer&&Pt(w)}function Kt(w){const x=w.textures;for(let U=0,Y=x.length;U<Y;U++){const J=x[U];if(d(J)){const X=w.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:i.TEXTURE_2D,St=n.get(J).__webglTexture;e.bindTexture(X,St),p(X),e.unbindTexture()}}}const zt=[],C=[];function Ce(w){if(w.samples>0){if(Gt(w)===!1){const x=w.textures,U=w.width,Y=w.height;let J=i.COLOR_BUFFER_BIT;const X=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,St=n.get(w),st=x.length>1;if(st)for(let ft=0;ft<x.length;ft++)e.bindFramebuffer(i.FRAMEBUFFER,St.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ft,i.RENDERBUFFER,null),e.bindFramebuffer(i.FRAMEBUFFER,St.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ft,i.TEXTURE_2D,null,0);e.bindFramebuffer(i.READ_FRAMEBUFFER,St.__webglMultisampledFramebuffer),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,St.__webglFramebuffer);for(let ft=0;ft<x.length;ft++){if(w.resolveDepthBuffer&&(w.depthBuffer&&(J|=i.DEPTH_BUFFER_BIT),w.stencilBuffer&&w.resolveStencilBuffer&&(J|=i.STENCIL_BUFFER_BIT)),st){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,St.__webglColorRenderbuffer[ft]);const Ht=n.get(x[ft]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Ht,0)}i.blitFramebuffer(0,0,U,Y,0,0,U,Y,J,i.NEAREST),l===!0&&(zt.length=0,C.length=0,zt.push(i.COLOR_ATTACHMENT0+ft),w.depthBuffer&&w.resolveDepthBuffer===!1&&(zt.push(X),C.push(X),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,C)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,zt))}if(e.bindFramebuffer(i.READ_FRAMEBUFFER,null),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),st)for(let ft=0;ft<x.length;ft++){e.bindFramebuffer(i.FRAMEBUFFER,St.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ft,i.RENDERBUFFER,St.__webglColorRenderbuffer[ft]);const Ht=n.get(x[ft]).__webglTexture;e.bindFramebuffer(i.FRAMEBUFFER,St.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ft,i.TEXTURE_2D,Ht,0)}e.bindFramebuffer(i.DRAW_FRAMEBUFFER,St.__webglMultisampledFramebuffer)}else if(w.depthBuffer&&w.resolveDepthBuffer===!1&&l){const x=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[x])}}}function Nt(w){return Math.min(s.maxSamples,w.samples)}function Gt(w){const x=n.get(w);return w.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&x.__useRenderToTexture!==!1}function Tt(w){const x=a.render.frame;h.get(w)!==x&&(h.set(w,x),w.update())}function Qt(w,x){const U=w.colorSpace,Y=w.format,J=w.type;return w.isCompressedTexture===!0||w.isVideoTexture===!0||U!==En&&U!==_n&&(qt.getTransfer(U)===ee?(Y!==Xe||J!==on)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",U)),x}function Rt(w){return typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement?(c.width=w.naturalWidth||w.width,c.height=w.naturalHeight||w.height):typeof VideoFrame<"u"&&w instanceof VideoFrame?(c.width=w.displayWidth,c.height=w.displayHeight):(c.width=w.width,c.height=w.height),c}this.allocateTextureUnit=V,this.resetTextureUnits=E,this.setTexture2D=q,this.setTexture2DArray=Z,this.setTexture3D=G,this.setTextureCube=j,this.rebindTextures=bt,this.setupRenderTarget=Bt,this.updateRenderTargetMipmap=Kt,this.updateMultisampleRenderTarget=Ce,this.setupDepthRenderbuffer=Pt,this.setupFrameBufferTexture=Q,this.useMultisampledRTT=Gt}function zp(i,t){function e(n,s=_n){let r;const a=qt.getTransfer(s);if(n===on)return i.UNSIGNED_BYTE;if(n===ma)return i.UNSIGNED_SHORT_4_4_4_4;if(n===ga)return i.UNSIGNED_SHORT_5_5_5_1;if(n===al)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===sl)return i.BYTE;if(n===rl)return i.SHORT;if(n===Di)return i.UNSIGNED_SHORT;if(n===pa)return i.INT;if(n===Nn)return i.UNSIGNED_INT;if(n===rn)return i.FLOAT;if(n===Fi)return i.HALF_FLOAT;if(n===ol)return i.ALPHA;if(n===ll)return i.RGB;if(n===Xe)return i.RGBA;if(n===cl)return i.LUMINANCE;if(n===hl)return i.LUMINANCE_ALPHA;if(n===li)return i.DEPTH_COMPONENT;if(n===pi)return i.DEPTH_STENCIL;if(n===ul)return i.RED;if(n===_a)return i.RED_INTEGER;if(n===dl)return i.RG;if(n===va)return i.RG_INTEGER;if(n===xa)return i.RGBA_INTEGER;if(n===ms||n===gs||n===_s||n===vs)if(a===ee)if(r=t.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===ms)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===gs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===_s)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===vs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=t.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===ms)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===gs)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===_s)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===vs)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Or||n===Br||n===zr||n===kr)if(r=t.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===Or)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Br)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===zr)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===kr)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Gr||n===Hr||n===Vr)if(r=t.get("WEBGL_compressed_texture_etc"),r!==null){if(n===Gr||n===Hr)return a===ee?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===Vr)return a===ee?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===Wr||n===Xr||n===qr||n===Yr||n===Kr||n===jr||n===Zr||n===$r||n===Jr||n===Qr||n===ta||n===ea||n===na||n===ia)if(r=t.get("WEBGL_compressed_texture_astc"),r!==null){if(n===Wr)return a===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Xr)return a===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===qr)return a===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Yr)return a===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Kr)return a===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===jr)return a===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Zr)return a===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===$r)return a===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Jr)return a===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Qr)return a===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===ta)return a===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===ea)return a===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===na)return a===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===ia)return a===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===xs||n===sa||n===ra)if(r=t.get("EXT_texture_compression_bptc"),r!==null){if(n===xs)return a===ee?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===sa)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===ra)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===fl||n===aa||n===oa||n===la)if(r=t.get("EXT_texture_compression_rgtc"),r!==null){if(n===xs)return r.COMPRESSED_RED_RGTC1_EXT;if(n===aa)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===oa)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===la)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===fi?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:e}}class kp extends Te{constructor(t=[]){super(),this.isArrayCamera=!0,this.cameras=t}}class Fe extends he{constructor(){super(),this.isGroup=!0,this.type="Group"}}const Gp={type:"move"};class gr{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Fe,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Fe,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new T,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new T),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Fe,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new T,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new T),this._grip}dispatchEvent(t){return this._targetRay!==null&&this._targetRay.dispatchEvent(t),this._grip!==null&&this._grip.dispatchEvent(t),this._hand!==null&&this._hand.dispatchEvent(t),this}connect(t){if(t&&t.hand){const e=this._hand;if(e)for(const n of t.hand.values())this._getHandJoint(e,n)}return this.dispatchEvent({type:"connected",data:t}),this}disconnect(t){return this.dispatchEvent({type:"disconnected",data:t}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(t,e,n){let s=null,r=null,a=null;const o=this._targetRay,l=this._grip,c=this._hand;if(t&&e.session.visibilityState!=="visible-blurred"){if(c&&t.hand){a=!0;for(const v of t.hand.values()){const d=e.getJointPose(v,n),p=this._getHandJoint(c,v);d!==null&&(p.matrix.fromArray(d.transform.matrix),p.matrix.decompose(p.position,p.rotation,p.scale),p.matrixWorldNeedsUpdate=!0,p.jointRadius=d.radius),p.visible=d!==null}const h=c.joints["index-finger-tip"],u=c.joints["thumb-tip"],f=h.position.distanceTo(u.position),m=.02,g=.005;c.inputState.pinching&&f>m+g?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:t.handedness,target:this})):!c.inputState.pinching&&f<=m-g&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:t.handedness,target:this}))}else l!==null&&t.gripSpace&&(r=e.getPose(t.gripSpace,n),r!==null&&(l.matrix.fromArray(r.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,r.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(r.linearVelocity)):l.hasLinearVelocity=!1,r.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(r.angularVelocity)):l.hasAngularVelocity=!1));o!==null&&(s=e.getPose(t.targetRaySpace,n),s===null&&r!==null&&(s=r),s!==null&&(o.matrix.fromArray(s.transform.matrix),o.matrix.decompose(o.position,o.rotation,o.scale),o.matrixWorldNeedsUpdate=!0,s.linearVelocity?(o.hasLinearVelocity=!0,o.linearVelocity.copy(s.linearVelocity)):o.hasLinearVelocity=!1,s.angularVelocity?(o.hasAngularVelocity=!0,o.angularVelocity.copy(s.angularVelocity)):o.hasAngularVelocity=!1,this.dispatchEvent(Gp)))}return o!==null&&(o.visible=s!==null),l!==null&&(l.visible=r!==null),c!==null&&(c.visible=a!==null),this}_getHandJoint(t,e){if(t.joints[e.jointName]===void 0){const n=new Fe;n.matrixAutoUpdate=!1,n.visible=!1,t.joints[e.jointName]=n,t.add(n)}return t.joints[e.jointName]}}const Hp=`
void main() {
