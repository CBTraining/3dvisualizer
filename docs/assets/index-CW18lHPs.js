...
`)+`
`+f);const y=T+u+a,w=T+f+o,O=bo(s,s.VERTEX_SHADER,y),R=bo(s,s.FRAGMENT_SHADER,w);s.attachShader(x,O),s.attachShader(x,R),e.index0AttributeName!==void 0?s.bindAttribLocation(x,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(x,0,"position"),s.linkProgram(x);function C(M){if(i.debug.checkShaderErrors){const W=s.getProgramInfoLog(x).trim(),z=s.getShaderInfoLog(O).trim(),X=s.getShaderInfoLog(R).trim();let K=!0,B=!0;if(s.getProgramParameter(x,s.LINK_STATUS)===!1)if(K=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,x,O,R);else{const j=wo(s,O,"vertex"),G=wo(s,R,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(x,s.VALIDATE_STATUS)+`
...
}`;function Up(i,t,e){let n=new Ea;const s=new tt,r=new tt,a=new Jt,o=new Pp({depthPacking:bc}),l=new Lp,c={},h=e.maxTextureSize,d={[Mn]:Ce,[Ce]:Mn,[ce]:ce},p=new yn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new tt},radius:{value:4}},vertexShader:Dp,fragmentShader:Ip}),m=p.clone();m.defines.HORIZONTAL_PASS=1;const g=new Se;g.setAttribute("position",new Ke(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new Ht(g,p),u=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Qo;let f=this.type;this.render=function(R,C,U){if(u.enabled===!1||u.autoUpdate===!1&&u.needsUpdate===!1||R.length===0)return;const it=i.getRenderTarget(),_=i.getActiveCubeFace(),M=i.getActiveMipmapLevel(),W=i.state;W.setBlending(xn),W.buffers.color.setClear(1,1,1,1),W.buffers.depth.setTest(!0),W.setScissorTest(!1);const z=f!==sn&&this.type===sn,X=f===sn&&this.type!==sn;for(let K=0,B=R.length;K<B;K++){const j=R[K],G=j.shadow;if(G===void 0){console.warn("THREE.WebGLShadowMap:",j,"has no shadow.");continue}if(G.autoUpdate===!1&&G.needsUpdate===!1)continue;s.copy(G.mapSize);const ht=G.getFrameExtents();if(s.multiply(ht),r.copy(G.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(r.x=Math.floor(h/ht.x),s.x=r.x*ht.x,G.mapSize.x=r.x),s.y>h&&(r.y=Math.floor(h/ht.y),s.y=r.y*ht.y,G.mapSize.y=r.y)),G.map===null||z===!0||X===!0){const H=this.type!==sn?{minFilter:Be,magFilter:Be}:{};G.map!==null&&G.map.dispose(),G.map=new Fn(s.x,s.y,H),G.map.texture.name=j.name+".shadowMap",G.camera.updateProjectionMatrix()}i.setRenderTarget(G.map),i.clear();const dt=G.getViewportCount();for(let H=0;H<dt;H++){const ft=G.getViewport(H);a.set(r.x*ft.x,r.y*ft.y,r.x*ft.z,r.y*ft.w),W.viewport(a),G.updateMatrices(j,H),n=G.getFrustum(),w(C,U,G.camera,j,this.type)}G.isPointLightShadow!==!0&&this.type===sn&&T(G,U),G.needsUpdate=!1}f=this.type,u.needsUpdate=!1,i.setRenderTarget(it,_,M)};function T(R,C){const U=t.update(x);p.defines.VSM_SAMPLES!==R.blurSamples&&(p.defines.VSM_SAMPLES=R.blurSamples,m.defines.VSM_SAMPLES=R.blurSamples,p.needsUpdate=!0,m.needsUpdate=!0),R.mapPass===null&&(R.mapPass=new Fn(s.x,s.y)),p.uniforms.shadow_pass.value=R.map.texture,p.uniforms.resolution.value=R.mapSize,p.uniforms.radius.value=R.radius,i.setRenderTarget(R.mapPass),i.clear(),i.renderBufferDirect(C,null,U,p,x,null),m.uniforms.shadow_pass.value=R.mapPass.texture,m.uniforms.resolution.value=R.mapSize,m.uniforms.radius.value=R.radius,i.setRenderTarget(R.map),i.clear(),i.renderBufferDirect(C,null,U,m,x,null)}function y(R,C,U,it){let _=null;const M=U.isPointLight===!0?R.customDistanceMaterial:R.customDepthMaterial;if(M!==void 0)_=M;else if(_=U.isPointLight===!0?l:o,i.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0){const W=_.uuid,z=C.uuid;let X=c[W];X===void 0&&(X={},c[W]=X);let K=X[z];K===void 0&&(K=_.clone(),X[z]=K,C.addEventListener("dispose",O)),_=K}if(_.visible=C.visible,_.wireframe=C.wireframe,it===sn?_.side=C.shadowSide!==null?C.shadowSide:C.side:_.side=C.shadowSide!==null?C.shadowSide:d[C.side],_.alphaMap=C.alphaMap,_.alphaTest=C.alphaTest,_.map=C.map,_.clipShadows=C.clipShadows,_.clippingPlanes=C.clippingPlanes,_.clipIntersection=C.clipIntersection,_.displacementMap=C.displacementMap,_.displacementScale=C.displacementScale,_.displacementBias=C.displacementBias,_.wireframeLinewidth=C.wireframeLinewidth,_.linewidth=C.linewidth,U.isPointLight===!0&&_.isMeshDistanceMaterial===!0){const W=i.properties.get(_);W.light=U}return _}function w(R,C,U,it,_){if(R.visible===!1)return;if(R.layers.test(C.layers)&&(R.isMesh||R.isLine||R.isPoints)&&(R.castShadow||R.receiveShadow&&_===sn)&&(!R.frustumCulled||n.intersectsObject(R))){R.modelViewMatrix.multiplyMatrices(U.matrixWorldInverse,R.matrixWorld);const z=t.update(R),X=R.material;if(Array.isArray(X)){const K=z.groups;for(let B=0,j=K.length;B<j;B++){const G=K[B],ht=X[G.materialIndex];if(ht&&ht.visible){const dt=y(R,ht,it,_);R.onBeforeShadow(i,R,C,U,z,dt,G),i.renderBufferDirect(U,null,z,dt,R,G),R.onAfterShadow(i,R,C,U,z,dt,G)}}}else if(X.visible){const K=y(R,X,it,_);R.onBeforeShadow(i,R,C,U,z,K,null),i.renderBufferDirect(U,null,z,K,R,null),R.onAfterShadow(i,R,C,U,z,K,null)}}const W=R.children;for(let z=0,X=W.length;z<X;z++)w(W[z],C,U,it,_)}function O(R){R.target.removeEventListener("dispose",O);for(const U in c){const it=c[U],_=R.target.uuid;_ in it&&(it[_].dispose(),delete it[_])}}}const Np={[Ar]:Cr,[Rr]:Dr,[Pr]:Ir,[hi]:Lr,[Cr]:Ar,[Dr]:Rr,[Ir]:Pr,[Lr]:hi};function Fp(i){function t(){let P=!1;const _t=new Jt;let V=null;const J=new Jt(0,0,0,0);return{setMask:function(pt){V!==pt&&!P&&(i.colorMask(pt,pt,pt,pt),V=pt)},setLocked:function(pt){P=pt},setClear:function(pt,vt,Xt,oe,Ee){Ee===!0&&(pt*=oe,vt*=oe,Xt*=oe),_t.set(pt,vt,Xt,oe),J.equals(_t)===!1&&(i.clearColor(pt,vt,Xt,oe),J.copy(_t))},reset:function(){P=!1,V=null,J.set(-1,0,0,0)}}}function e(){let P=!1,_t=!1,V=null,J=null,pt=null;return{setReversed:function(vt){_t=vt},setTest:function(vt){vt?yt(i.DEPTH_TEST):ut(i.DEPTH_TEST)},setMask:function(vt){V!==vt&&!P&&(i.depthMask(vt),V=vt)},setFunc:function(vt){if(_t&&(vt=Np[vt]),J!==vt){switch(vt){case Ar:i.depthFunc(i.NEVER);break;case Cr:i.depthFunc(i.ALWAYS);break;case Rr:i.depthFunc(i.LESS);break;case hi:i.depthFunc(i.LEQUAL);break;case Pr:i.depthFunc(i.EQUAL);break;case Lr:i.depthFunc(i.GEQUAL);break;case Dr:i.depthFunc(i.GREATER);break;case Ir:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}J=vt}},setLocked:function(vt){P=vt},setClear:function(vt){pt!==vt&&(i.clearDepth(vt),pt=vt)},reset:function(){P=!1,V=null,J=null,pt=null}}}function n(){let P=!1,_t=null,V=null,J=null,pt=null,vt=null,Xt=null,oe=null,Ee=null;return{setTest:function(qt){P||(qt?yt(i.STENCIL_TEST):ut(i.STENCIL_TEST))},setMask:function(qt){_t!==qt&&!P&&(i.stencilMask(qt),_t=qt)},setFunc:function(qt,be,Ze){(V!==qt||J!==be||pt!==Ze)&&(i.stencilFunc(qt,be,Ze),V=qt,J=be,pt=Ze)},setOp:function(qt,be,Ze){(vt!==qt||Xt!==be||oe!==Ze)&&(i.stencilOp(qt,be,Ze),vt=qt,Xt=be,oe=Ze)},setLocked:function(qt){P=qt},setClear:function(qt){Ee!==qt&&(i.clearStencil(qt),Ee=qt)},reset:function(){P=!1,_t=null,V=null,J=null,pt=null,vt=null,Xt=null,oe=null,Ee=null}}}const s=new t,r=new e,a=new n,o=new WeakMap,l=new WeakMap;let c={},h={},d=new WeakMap,p=[],m=null,g=!1,x=null,u=null,f=null,T=null,y=null,w=null,O=null,R=new Wt(0,0,0),C=0,U=!1,it=null,_=null,M=null,W=null,z=null;const X=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let K=!1,B=0;const j=i.getParameter(i.VERSION);j.indexOf("WebGL")!==-1?(B=parseFloat(/^WebGL (\d)/.exec(j)[1]),K=B>=1):j.indexOf("OpenGL ES")!==-1&&(B=parseFloat(/^OpenGL ES (\d)/.exec(j)[1]),K=B>=2);let G=null,ht={};const dt=i.getParameter(i.SCISSOR_BOX),H=i.getParameter(i.VIEWPORT),ft=new Jt().fromArray(dt),xt=new Jt().fromArray(H);function k(P,_t,V,J){const pt=new Uint8Array(4),vt=i.createTexture();i.bindTexture(P,vt),i.texParameteri(P,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(P,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Xt=0;Xt<V;Xt++)P===i.TEXTURE_3D||P===i.TEXTURE_2D_ARRAY?i.texImage3D(_t,0,i.RGBA,1,1,J,0,i.RGBA,i.UNSIGNED_BYTE,pt):i.texImage2D(_t+Xt,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,pt);return vt}const Q={};Q[i.TEXTURE_2D]=k(i.TEXTURE_2D,i.TEXTURE_2D,1),Q[i.TEXTURE_CUBE_MAP]=k(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),Q[i.TEXTURE_2D_ARRAY]=k(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),Q[i.TEXTURE_3D]=k(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),r.setClear(1),a.setClear(0),yt(i.DEPTH_TEST),r.setFunc(hi),rt(!1),et(za),yt(i.CULL_FACE),b(xn);function yt(P){c[P]!==!0&&(i.enable(P),c[P]=!0)}function ut(P){c[P]!==!1&&(i.disable(P),c[P]=!1)}function Lt(P,_t){return h[P]!==_t?(i.bindFramebuffer(P,_t),h[P]=_t,P===i.DRAW_FRAMEBUFFER&&(h[i.FRAMEBUFFER]=_t),P===i.FRAMEBUFFER&&(h[i.DRAW_FRAMEBUFFER]=_t),!0):!1}function Pt(P,_t){let V=p,J=!1;if(P){V=d.get(_t),V===void 0&&(V=[],d.set(_t,V));const pt=P.textures;if(V.length!==pt.length||V[0]!==i.COLOR_ATTACHMENT0){for(let vt=0,Xt=pt.length;vt<Xt;vt++)V[vt]=i.COLOR_ATTACHMENT0+vt;V.length=pt.length,J=!0}}else V[0]!==i.BACK&&(V[0]=i.BACK,J=!0);J&&i.drawBuffers(V)}function Ft(P){return m!==P?(i.useProgram(P),m=P,!0):!1}const kt={[Dn]:i.FUNC_ADD,[$l]:i.FUNC_SUBTRACT,[Jl]:i.FUNC_REVERSE_SUBTRACT};kt[Ql]=i.MIN,kt[tc]=i.MAX;const Z={[ec]:i.ZERO,[nc]:i.ONE,[ic]:i.SRC_COLOR,[wr]:i.SRC_ALPHA,[cc]:i.SRC_ALPHA_SATURATE,[oc]:i.DST_COLOR,[rc]:i.DST_ALPHA,[sc]:i.ONE_MINUS_SRC_COLOR,[Tr]:i.ONE_MINUS_SRC_ALPHA,[lc]:i.ONE_MINUS_DST_COLOR,[ac]:i.ONE_MINUS_DST_ALPHA,[hc]:i.CONSTANT_COLOR,[uc]:i.ONE_MINUS_CONSTANT_COLOR,[dc]:i.CONSTANT_ALPHA,[fc]:i.ONE_MINUS_CONSTANT_ALPHA};function b(P,_t,V,J,pt,vt,Xt,oe,Ee,qt){if(P===xn){g===!0&&(ut(i.BLEND),g=!1);return}if(g===!1&&(yt(i.BLEND),g=!0),P!==Zl){if(P!==x||qt!==U){if((u!==Dn||y!==Dn)&&(i.blendEquation(i.FUNC_ADD),u=Dn,y=Dn),qt)switch(P){case oi:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case ka:i.blendFunc(i.ONE,i.ONE);break;case Ga:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Va:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",P);break}else switch(P){case oi:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case ka:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case Ga:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Va:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",P);break}f=null,T=null,w=null,O=null,R.set(0,0,0),C=0,x=P,U=qt}return}pt=pt||_t,vt=vt||V,Xt=Xt||J,(_t!==u||pt!==y)&&(i.blendEquationSeparate(kt[_t],kt[pt]),u=_t,y=pt),(V!==f||J!==T||vt!==w||Xt!==O)&&(i.blendFuncSeparate(Z[V],Z[J],Z[vt],Z[Xt]),f=V,T=J,w=vt,O=Xt),(oe.equals(R)===!1||Ee!==C)&&(i.blendColor(oe.r,oe.g,oe.b,Ee),R.copy(oe),C=Ee),x=P,U=!1}function at(P,_t){P.side===ce?ut(i.CULL_FACE):yt(i.CULL_FACE);let V=P.side===Ce;_t&&(V=!V),rt(V),P.blending===oi&&P.transparent===!1?b(xn):b(P.blending,P.blendEquation,P.blendSrc,P.blendDst,P.blendEquationAlpha,P.blendSrcAlpha,P.blendDstAlpha,P.blendColor,P.blendAlpha,P.premultipliedAlpha),r.setFunc(P.depthFunc),r.setTest(P.depthTest),r.setMask(P.depthWrite),s.setMask(P.colorWrite);const J=P.stencilWrite;a.setTest(J),J&&(a.setMask(P.stencilWriteMask),a.setFunc(P.stencilFunc,P.stencilRef,P.stencilFuncMask),a.setOp(P.stencilFail,P.stencilZFail,P.stencilZPass)),Ct(P.polygonOffset,P.polygonOffsetFactor,P.polygonOffsetUnits),P.alphaToCoverage===!0?yt(i.SAMPLE_ALPHA_TO_COVERAGE):ut(i.SAMPLE_ALPHA_TO_COVERAGE)}function rt(P){it!==P&&(P?i.frontFace(i.CW):i.frontFace(i.CCW),it=P)}function et(P){P!==Kl?(yt(i.CULL_FACE),P!==_&&(P===za?i.cullFace(i.BACK):P===jl?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):ut(i.CULL_FACE),_=P}function ot(P){P!==M&&(K&&i.lineWidth(P),M=P)}function Ct(P,_t,V){P?(yt(i.POLYGON_OFFSET_FILL),(W!==_t||z!==V)&&(i.polygonOffset(_t,V),W=_t,z=V)):ut(i.POLYGON_OFFSET_FILL)}function gt(P){P?yt(i.SCISSOR_TEST):ut(i.SCISSOR_TEST)}function E(P){P===void 0&&(P=i.TEXTURE0+X-1),G!==P&&(i.activeTexture(P),G=P)}function v(P,_t,V){V===void 0&&(G===null?V=i.TEXTURE0+X-1:V=G);let J=ht[V];J===void 0&&(J={type:void 0,texture:void 0},ht[V]=J),(J.type!==P||J.texture!==_t)&&(G!==V&&(i.activeTexture(V),G=V),i.bindTexture(P,_t||Q[P]),J.type=P,J.texture=_t)}function I(){const P=ht[G];P!==void 0&&P.type!==void 0&&(i.bindTexture(P.type,null),P.type=void 0,P.texture=void 0)}function q(){try{i.compressedTexImage2D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function $(){try{i.compressedTexImage3D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Y(){try{i.texSubImage2D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function wt(){try{i.texSubImage3D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function lt(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function St(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Gt(){try{i.texStorage2D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function nt(){try{i.texStorage3D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Mt(){try{i.texImage2D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Ut(){try{i.texImage3D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Nt(P){ft.equals(P)===!1&&(i.scissor(P.x,P.y,P.z,P.w),ft.copy(P))}function Et(P){xt.equals(P)===!1&&(i.viewport(P.x,P.y,P.z,P.w),xt.copy(P))}function Vt(P,_t){let V=l.get(_t);V===void 0&&(V=new WeakMap,l.set(_t,V));let J=V.get(P);J===void 0&&(J=i.getUniformBlockIndex(_t,P.name),V.set(P,J))}function Ot(P,_t){const J=l.get(_t).get(P);o.get(_t)!==J&&(i.uniformBlockBinding(_t,J,P.__bindingPointIndex),o.set(_t,J))}function Qt(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),c={},G=null,ht={},h={},d=new WeakMap,p=[],m=null,g=!1,x=null,u=null,f=null,T=null,y=null,w=null,O=null,R=new Wt(0,0,0),C=0,U=!1,it=null,_=null,M=null,W=null,z=null,ft.set(0,0,i.canvas.width,i.canvas.height),xt.set(0,0,i.canvas.width,i.canvas.height),s.reset(),r.reset(),a.reset()}return{buffers:{color:s,depth:r,stencil:a},enable:yt,disable:ut,bindFramebuffer:Lt,drawBuffers:Pt,useProgram:Ft,setBlending:b,setMaterial:at,setFlipSided:rt,setCullFace:et,setLineWidth:ot,setPolygonOffset:Ct,setScissorTest:gt,activeTexture:E,bindTexture:v,unbindTexture:I,compressedTexImage2D:q,compressedTexImage3D:$,texImage2D:Mt,texImage3D:Ut,updateUBOMapping:Vt,uniformBlockBinding:Ot,texStorage2D:Gt,texStorage3D:nt,texSubImage2D:Y,texSubImage3D:wt,compressedTexSubImage2D:lt,compressedTexSubImage3D:St,scissor:Nt,viewport:Et,reset:Qt}}function Io(i,t,e,n){const s=Op(n);switch(e){case ol:return i*t;case cl:return i*t;case hl:return i*t*2;case ul:return i*t/s.components*s.byteLength;case va:return i*t/s.components*s.byteLength;case dl:return i*t*2/s.components*s.byteLength;case xa:return i*t*2/s.components*s.byteLength;case ll:return i*t*3/s.components*s.byteLength;case Xe:return i*t*4/s.components*s.byteLength;case Sa:return i*t*4/s.components*s.byteLength;case ms:case gs:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*8;case _s:case vs:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*16;case Br:case kr:return Math.max(i,16)*Math.max(t,8)/4;case Or:case zr:return Math.max(i,8)*Math.max(t,8)/2;case Gr:case Vr:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*8;case Hr:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*16;case Wr:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*16;case Xr:return Math.floor((i+4)/5)*Math.floor((t+3)/4)*16;case qr:return Math.floor((i+4)/5)*Math.floor((t+4)/5)*16;case Yr:return Math.floor((i+5)/6)*Math.floor((t+4)/5)*16;case Kr:return Math.floor((i+5)/6)*Math.floor((t+5)/6)*16;case jr:return Math.floor((i+7)/8)*Math.floor((t+4)/5)*16;case Zr:return Math.floor((i+7)/8)*Math.floor((t+5)/6)*16;case $r:return Math.floor((i+7)/8)*Math.floor((t+7)/8)*16;case Jr:return Math.floor((i+9)/10)*Math.floor((t+4)/5)*16;case Qr:return Math.floor((i+9)/10)*Math.floor((t+5)/6)*16;case ta:return Math.floor((i+9)/10)*Math.floor((t+7)/8)*16;case ea:return Math.floor((i+9)/10)*Math.floor((t+9)/10)*16;case na:return Math.floor((i+11)/12)*Math.floor((t+9)/10)*16;case ia:return Math.floor((i+11)/12)*Math.floor((t+11)/12)*16;case xs:case sa:case ra:return Math.ceil(i/4)*Math.ceil(t/4)*16;case fl:case aa:return Math.ceil(i/4)*Math.ceil(t/4)*8;case oa:case la:return Math.ceil(i/4)*Math.ceil(t/4)*16}throw new Error(`Unable to determine texture byte length for ${e} format.`)}function Op(i){switch(i){case on:case sl:return{byteLength:1,components:1};case Di:case rl:case Fi:return{byteLength:2,components:1};case ga:case _a:return{byteLength:2,components:4};case Nn:case ma:case rn:return{byteLength:4,components:1};case al:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${i}.`)}function Bp(i,t,e,n,s,r,a){const o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new tt,h=new WeakMap;let d;const p=new WeakMap;let m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(E,v){return m?new OffscreenCanvas(E,v):Cs("canvas")}function x(E,v,I){let q=1;const $=gt(E);if(($.width>I||$.height>I)&&(q=I/Math.max($.width,$.height)),q<1)if(typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&E instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&E instanceof ImageBitmap||typeof VideoFrame<"u"&&E instanceof VideoFrame){const Y=Math.floor(q*$.width),wt=Math.floor(q*$.height);d===void 0&&(d=g(Y,wt));const lt=v?g(Y,wt):d;return lt.width=Y,lt.height=wt,lt.getContext("2d").drawImage(E,0,0,Y,wt),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+$.width+"x"+$.height+") to ("+Y+"x"+wt+")."),lt}else return"data"in E&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+$.width+"x"+$.height+")."),E;return E}function u(E){return E.generateMipmaps&&E.minFilter!==Be&&E.minFilter!==Oe}function f(E){i.generateMipmap(E)}function T(E,v,I,q,$=!1){if(E!==null){if(i[E]!==void 0)return i[E];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+E+"'")}let Y=v;if(v===i.RED&&(I===i.FLOAT&&(Y=i.R32F),I===i.HALF_FLOAT&&(Y=i.R16F),I===i.UNSIGNED_BYTE&&(Y=i.R8)),v===i.RED_INTEGER&&(I===i.UNSIGNED_BYTE&&(Y=i.R8UI),I===i.UNSIGNED_SHORT&&(Y=i.R16UI),I===i.UNSIGNED_INT&&(Y=i.R32UI),I===i.BYTE&&(Y=i.R8I),I===i.SHORT&&(Y=i.R16I),I===i.INT&&(Y=i.R32I)),v===i.RG&&(I===i.FLOAT&&(Y=i.RG32F),I===i.HALF_FLOAT&&(Y=i.RG16F),I===i.UNSIGNED_BYTE&&(Y=i.RG8)),v===i.RG_INTEGER&&(I===i.UNSIGNED_BYTE&&(Y=i.RG8UI),I===i.UNSIGNED_SHORT&&(Y=i.RG16UI),I===i.UNSIGNED_INT&&(Y=i.RG32UI),I===i.BYTE&&(Y=i.RG8I),I===i.SHORT&&(Y=i.RG16I),I===i.INT&&(Y=i.RG32I)),v===i.RGB_INTEGER&&(I===i.UNSIGNED_BYTE&&(Y=i.RGB8UI),I===i.UNSIGNED_SHORT&&(Y=i.RGB16UI),I===i.UNSIGNED_INT&&(Y=i.RGB32UI),I===i.BYTE&&(Y=i.RGB8I),I===i.SHORT&&(Y=i.RGB16I),I===i.INT&&(Y=i.RGB32I)),v===i.RGBA_INTEGER&&(I===i.UNSIGNED_BYTE&&(Y=i.RGBA8UI),I===i.UNSIGNED_SHORT&&(Y=i.RGBA16UI),I===i.UNSIGNED_INT&&(Y=i.RGBA32UI),I===i.BYTE&&(Y=i.RGBA8I),I===i.SHORT&&(Y=i.RGBA16I),I===i.INT&&(Y=i.RGBA32I)),v===i.RGB&&I===i.UNSIGNED_INT_5_9_9_9_REV&&(Y=i.RGB9_E5),v===i.RGBA){const wt=$?Es:jt.getTransfer(q);I===i.FLOAT&&(Y=i.RGBA32F),I===i.HALF_FLOAT&&(Y=i.RGBA16F),I===i.UNSIGNED_BYTE&&(Y=wt===ne?i.SRGB8_ALPHA8:i.RGBA8),I===i.UNSIGNED_SHORT_4_4_4_4&&(Y=i.RGBA4),I===i.UNSIGNED_SHORT_5_5_5_1&&(Y=i.RGB5_A1)}return(Y===i.R16F||Y===i.R32F||Y===i.RG16F||Y===i.RG32F||Y===i.RGBA16F||Y===i.RGBA32F)&&t.get("EXT_color_buffer_float"),Y}function y(E,v){let I;return E?v===null||v===Nn||v===fi?I=i.DEPTH24_STENCIL8:v===rn?I=i.DEPTH32F_STENCIL8:v===Di&&(I=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):v===null||v===Nn||v===fi?I=i.DEPTH_COMPONENT24:v===rn?I=i.DEPTH_COMPONENT32F:v===Di&&(I=i.DEPTH_COMPONENT16),I}function w(E,v){return u(E)===!0||E.isFramebufferTexture&&E.minFilter!==Be&&E.minFilter!==Oe?Math.log2(Math.max(v.width,v.height))+1:E.mipmaps!==void 0&&E.mipmaps.length>0?E.mipmaps.length:E.isCompressedTexture&&Array.isArray(E.image)?v.mipmaps.length:1}function O(E){const v=E.target;v.removeEventListener("dispose",O),C(v),v.isVideoTexture&&h.delete(v)}function R(E){const v=E.target;v.removeEventListener("dispose",R),it(v)}function C(E){const v=n.get(E);if(v.__webglInit===void 0)return;const I=E.source,q=p.get(I);if(q){const $=q[v.__cacheKey];$.usedTimes--,$.usedTimes===0&&U(E),Object.keys(q).length===0&&p.delete(I)}n.remove(E)}function U(E){const v=n.get(E);i.deleteTexture(v.__webglTexture);const I=E.source,q=p.get(I);delete q[v.__cacheKey],a.memory.textures--}function it(E){const v=n.get(E);if(E.depthTexture&&E.depthTexture.dispose(),E.isWebGLCubeRenderTarget)for(let q=0;q<6;q++){if(Array.isArray(v.__webglFramebuffer[q]))for(let $=0;$<v.__webglFramebuffer[q].length;$++)i.deleteFramebuffer(v.__webglFramebuffer[q][$]);else i.deleteFramebuffer(v.__webglFramebuffer[q]);v.__webglDepthbuffer&&i.deleteRenderbuffer(v.__webglDepthbuffer[q])}else{if(Array.isArray(v.__webglFramebuffer))for(let q=0;q<v.__webglFramebuffer.length;q++)i.deleteFramebuffer(v.__webglFramebuffer[q]);else i.deleteFramebuffer(v.__webglFramebuffer);if(v.__webglDepthbuffer&&i.deleteRenderbuffer(v.__webglDepthbuffer),v.__webglMultisampledFramebuffer&&i.deleteFramebuffer(v.__webglMultisampledFramebuffer),v.__webglColorRenderbuffer)for(let q=0;q<v.__webglColorRenderbuffer.length;q++)v.__webglColorRenderbuffer[q]&&i.deleteRenderbuffer(v.__webglColorRenderbuffer[q]);v.__webglDepthRenderbuffer&&i.deleteRenderbuffer(v.__webglDepthRenderbuffer)}const I=E.textures;for(let q=0,$=I.length;q<$;q++){const Y=n.get(I[q]);Y.__webglTexture&&(i.deleteTexture(Y.__webglTexture),a.memory.textures--),n.remove(I[q])}n.remove(E)}let _=0;function M(){_=0}function W(){const E=_;return E>=s.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+E+" texture units while this GPU supports only "+s.maxTextures),_+=1,E}function z(E){const v=[];return v.push(E.wrapS),v.push(E.wrapT),v.push(E.wrapR||0),v.push(E.magFilter),v.push(E.minFilter),v.push(E.anisotropy),v.push(E.internalFormat),v.push(E.format),v.push(E.type),v.push(E.generateMipmaps),v.push(E.premultiplyAlpha),v.push(E.flipY),v.push(E.unpackAlignment),v.push(E.colorSpace),v.join()}function X(E,v){const I=n.get(E);if(E.isVideoTexture&&ot(E),E.isRenderTargetTexture===!1&&E.version>0&&I.__version!==E.version){const q=E.image;if(q===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(q.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{xt(I,E,v);return}}e.bindTexture(i.TEXTURE_2D,I.__webglTexture,i.TEXTURE0+v)}function K(E,v){const I=n.get(E);if(E.version>0&&I.__version!==E.version){xt(I,E,v);return}e.bindTexture(i.TEXTURE_2D_ARRAY,I.__webglTexture,i.TEXTURE0+v)}function B(E,v){const I=n.get(E);if(E.version>0&&I.__version!==E.version){xt(I,E,v);return}e.bindTexture(i.TEXTURE_3D,I.__webglTexture,i.TEXTURE0+v)}function j(E,v){const I=n.get(E);if(E.version>0&&I.__version!==E.version){k(I,E,v);return}e.bindTexture(i.TEXTURE_CUBE_MAP,I.__webglTexture,i.TEXTURE0+v)}const G={[Li]:i.REPEAT,[Un]:i.CLAMP_TO_EDGE,[Fr]:i.MIRRORED_REPEAT},ht={[Be]:i.NEAREST,[yc]:i.NEAREST_MIPMAP_NEAREST,[Vi]:i.NEAREST_MIPMAP_LINEAR,[Oe]:i.LINEAR,[Gs]:i.LINEAR_MIPMAP_NEAREST,[vn]:i.LINEAR_MIPMAP_LINEAR},dt={[Tc]:i.NEVER,[Dc]:i.ALWAYS,[Ac]:i.LESS,[ml]:i.LEQUAL,[Cc]:i.EQUAL,[Lc]:i.GEQUAL,[Rc]:i.GREATER,[Pc]:i.NOTEQUAL};function H(E,v){if(v.type===rn&&t.has("OES_texture_float_linear")===!1&&(v.magFilter===Oe||v.magFilter===Gs||v.magFilter===Vi||v.magFilter===vn||v.minFilter===Oe||v.minFilter===Gs||v.minFilter===Vi||v.minFilter===vn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(E,i.TEXTURE_WRAP_S,G[v.wrapS]),i.texParameteri(E,i.TEXTURE_WRAP_T,G[v.wrapT]),(E===i.TEXTURE_3D||E===i.TEXTURE_2D_ARRAY)&&i.texParameteri(E,i.TEXTURE_WRAP_R,G[v.wrapR]),i.texParameteri(E,i.TEXTURE_MAG_FILTER,ht[v.magFilter]),i.texParameteri(E,i.TEXTURE_MIN_FILTER,ht[v.minFilter]),v.compareFunction&&(i.texParameteri(E,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(E,i.TEXTURE_COMPARE_FUNC,dt[v.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(v.magFilter===Be||v.minFilter!==Vi&&v.minFilter!==vn||v.type===rn&&t.has("OES_texture_float_linear")===!1)return;if(v.anisotropy>1||n.get(v).__currentAnisotropy){const I=t.get("EXT_texture_filter_anisotropic");i.texParameterf(E,I.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(v.anisotropy,s.getMaxAnisotropy())),n.get(v).__currentAnisotropy=v.anisotropy}}}function ft(E,v){let I=!1;E.__webglInit===void 0&&(E.__webglInit=!0,v.addEventListener("dispose",O));const q=v.source;let $=p.get(q);$===void 0&&($={},p.set(q,$));const Y=z(v);if(Y!==E.__cacheKey){$[Y]===void 0&&($[Y]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,I=!0),$[Y].usedTimes++;const wt=$[E.__cacheKey];wt!==void 0&&($[E.__cacheKey].usedTimes--,wt.usedTimes===0&&U(v)),E.__cacheKey=Y,E.__webglTexture=$[Y].texture}return I}function xt(E,v,I){let q=i.TEXTURE_2D;(v.isDataArrayTexture||v.isCompressedArrayTexture)&&(q=i.TEXTURE_2D_ARRAY),v.isData3DTexture&&(q=i.TEXTURE_3D);const $=ft(E,v),Y=v.source;e.bindTexture(q,E.__webglTexture,i.TEXTURE0+I);const wt=n.get(Y);if(Y.version!==wt.__version||$===!0){e.activeTexture(i.TEXTURE0+I);const lt=jt.getPrimaries(jt.workingColorSpace),St=v.colorSpace===_n?null:jt.getPrimaries(v.colorSpace),Gt=v.colorSpace===_n||lt===St?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,v.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,v.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Gt);let nt=x(v.image,!1,s.maxTextureSize);nt=Ct(v,nt);const Mt=r.convert(v.format,v.colorSpace),Ut=r.convert(v.type);let Nt=T(v.internalFormat,Mt,Ut,v.colorSpace,v.isVideoTexture);H(q,v);let Et;const Vt=v.mipmaps,Ot=v.isVideoTexture!==!0,Qt=wt.__version===void 0||$===!0,P=Y.dataReady,_t=w(v,nt);if(v.isDepthTexture)Nt=y(v.format===pi,v.type),Qt&&(Ot?e.texStorage2D(i.TEXTURE_2D,1,Nt,nt.width,nt.height):e.texImage2D(i.TEXTURE_2D,0,Nt,nt.width,nt.height,0,Mt,Ut,null));else if(v.isDataTexture)if(Vt.length>0){Ot&&Qt&&e.texStorage2D(i.TEXTURE_2D,_t,Nt,Vt[0].width,Vt[0].height);for(let V=0,J=Vt.length;V<J;V++)Et=Vt[V],Ot?P&&e.texSubImage2D(i.TEXTURE_2D,V,0,0,Et.width,Et.height,Mt,Ut,Et.data):e.texImage2D(i.TEXTURE_2D,V,Nt,Et.width,Et.height,0,Mt,Ut,Et.data);v.generateMipmaps=!1}else Ot?(Qt&&e.texStorage2D(i.TEXTURE_2D,_t,Nt,nt.width,nt.height),P&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,nt.width,nt.height,Mt,Ut,nt.data)):e.texImage2D(i.TEXTURE_2D,0,Nt,nt.width,nt.height,0,Mt,Ut,nt.data);else if(v.isCompressedTexture)if(v.isCompressedArrayTexture){Ot&&Qt&&e.texStorage3D(i.TEXTURE_2D_ARRAY,_t,Nt,Vt[0].width,Vt[0].height,nt.depth);for(let V=0,J=Vt.length;V<J;V++)if(Et=Vt[V],v.format!==Xe)if(Mt!==null)if(Ot){if(P)if(v.layerUpdates.size>0){const pt=Io(Et.width,Et.height,v.format,v.type);for(const vt of v.layerUpdates){const Xt=Et.data.subarray(vt*pt/Et.data.BYTES_PER_ELEMENT,(vt+1)*pt/Et.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,V,0,0,vt,Et.width,Et.height,1,Mt,Xt,0,0)}v.clearLayerUpdates()}else e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,V,0,0,0,Et.width,Et.height,nt.depth,Mt,Et.data,0,0)}else e.compressedTexImage3D(i.TEXTURE_2D_ARRAY,V,Nt,Et.width,Et.height,nt.depth,0,Et.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ot?P&&e.texSubImage3D(i.TEXTURE_2D_ARRAY,V,0,0,0,Et.width,Et.height,nt.depth,Mt,Ut,Et.data):e.texImage3D(i.TEXTURE_2D_ARRAY,V,Nt,Et.width,Et.height,nt.depth,0,Mt,Ut,Et.data)}else{Ot&&Qt&&e.texStorage2D(i.TEXTURE_2D,_t,Nt,Vt[0].width,Vt[0].height);for(let V=0,J=Vt.length;V<J;V++)Et=Vt[V],v.format!==Xe?Mt!==null?Ot?P&&e.compressedTexSubImage2D(i.TEXTURE_2D,V,0,0,Et.width,Et.height,Mt,Et.data):e.compressedTexImage2D(i.TEXTURE_2D,V,Nt,Et.width,Et.height,0,Et.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ot?P&&e.texSubImage2D(i.TEXTURE_2D,V,0,0,Et.width,Et.height,Mt,Ut,Et.data):e.texImage2D(i.TEXTURE_2D,V,Nt,Et.width,Et.height,0,Mt,Ut,Et.data)}else if(v.isDataArrayTexture)if(Ot){if(Qt&&e.texStorage3D(i.TEXTURE_2D_ARRAY,_t,Nt,nt.width,nt.height,nt.depth),P)if(v.layerUpdates.size>0){const V=Io(nt.width,nt.height,v.format,v.type);for(const J of v.layerUpdates){const pt=nt.data.subarray(J*V/nt.data.BYTES_PER_ELEMENT,(J+1)*V/nt.data.BYTES_PER_ELEMENT);e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,J,nt.width,nt.height,1,Mt,Ut,pt)}v.clearLayerUpdates()}else e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,nt.width,nt.height,nt.depth,Mt,Ut,nt.data)}else e.texImage3D(i.TEXTURE_2D_ARRAY,0,Nt,nt.width,nt.height,nt.depth,0,Mt,Ut,nt.data);else if(v.isData3DTexture)Ot?(Qt&&e.texStorage3D(i.TEXTURE_3D,_t,Nt,nt.width,nt.height,nt.depth),P&&e.texSubImage3D(i.TEXTURE_3D,0,0,0,0,nt.width,nt.height,nt.depth,Mt,Ut,nt.data)):e.texImage3D(i.TEXTURE_3D,0,Nt,nt.width,nt.height,nt.depth,0,Mt,Ut,nt.data);else if(v.isFramebufferTexture){if(Qt)if(Ot)e.texStorage2D(i.TEXTURE_2D,_t,Nt,nt.width,nt.height);else{let V=nt.width,J=nt.height;for(let pt=0;pt<_t;pt++)e.texImage2D(i.TEXTURE_2D,pt,Nt,V,J,0,Mt,Ut,null),V>>=1,J>>=1}}else if(Vt.length>0){if(Ot&&Qt){const V=gt(Vt[0]);e.texStorage2D(i.TEXTURE_2D,_t,Nt,V.width,V.height)}for(let V=0,J=Vt.length;V<J;V++)Et=Vt[V],Ot?P&&e.texSubImage2D(i.TEXTURE_2D,V,0,0,Mt,Ut,Et):e.texImage2D(i.TEXTURE_2D,V,Nt,Mt,Ut,Et);v.generateMipmaps=!1}else if(Ot){if(Qt){const V=gt(nt);e.texStorage2D(i.TEXTURE_2D,_t,Nt,V.width,V.height)}P&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,Mt,Ut,nt)}else e.texImage2D(i.TEXTURE_2D,0,Nt,Mt,Ut,nt);u(v)&&f(q),wt.__version=Y.version,v.onUpdate&&v.onUpdate(v)}E.__version=v.version}function k(E,v,I){if(v.image.length!==6)return;const q=ft(E,v),$=v.source;e.bindTexture(i.TEXTURE_CUBE_MAP,E.__webglTexture,i.TEXTURE0+I);const Y=n.get($);if($.version!==Y.__version||q===!0){e.activeTexture(i.TEXTURE0+I);const wt=jt.getPrimaries(jt.workingColorSpace),lt=v.colorSpace===_n?null:jt.getPrimaries(v.colorSpace),St=v.colorSpace===_n||wt===lt?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,v.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,v.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,St);const Gt=v.isCompressedTexture||v.image[0].isCompressedTexture,nt=v.image[0]&&v.image[0].isDataTexture,Mt=[];for(let J=0;J<6;J++)!Gt&&!nt?Mt[J]=x(v.image[J],!0,s.maxCubemapSize):Mt[J]=nt?v.image[J].image:v.image[J],Mt[J]=Ct(v,Mt[J]);const Ut=Mt[0],Nt=r.convert(v.format,v.colorSpace),Et=r.convert(v.type),Vt=T(v.internalFormat,Nt,Et,v.colorSpace),Ot=v.isVideoTexture!==!0,Qt=Y.__version===void 0||q===!0,P=$.dataReady;let _t=w(v,Ut);H(i.TEXTURE_CUBE_MAP,v);let V;if(Gt){Ot&&Qt&&e.texStorage2D(i.TEXTURE_CUBE_MAP,_t,Vt,Ut.width,Ut.height);for(let J=0;J<6;J++){V=Mt[J].mipmaps;for(let pt=0;pt<V.length;pt++){const vt=V[pt];v.format!==Xe?Nt!==null?Ot?P&&e.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,pt,0,0,vt.width,vt.height,Nt,vt.data):e.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,pt,Vt,vt.width,vt.height,0,vt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Ot?P&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,pt,0,0,vt.width,vt.height,Nt,Et,vt.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,pt,Vt,vt.width,vt.height,0,Nt,Et,vt.data)}}}else{if(V=v.mipmaps,Ot&&Qt){V.length>0&&_t++;const J=gt(Mt[0]);e.texStorage2D(i.TEXTURE_CUBE_MAP,_t,Vt,J.width,J.height)}for(let J=0;J<6;J++)if(nt){Ot?P&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,0,0,Mt[J].width,Mt[J].height,Nt,Et,Mt[J].data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,Vt,Mt[J].width,Mt[J].height,0,Nt,Et,Mt[J].data);for(let pt=0;pt<V.length;pt++){const Xt=V[pt].image[J].image;Ot?P&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,pt+1,0,0,Xt.width,Xt.height,Nt,Et,Xt.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,pt+1,Vt,Xt.width,Xt.height,0,Nt,Et,Xt.data)}}else{Ot?P&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,0,0,Nt,Et,Mt[J]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,Vt,Nt,Et,Mt[J]);for(let pt=0;pt<V.length;pt++){const vt=V[pt];Ot?P&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,pt+1,0,0,Nt,Et,vt.image[J]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,pt+1,Vt,Nt,Et,vt.image[J])}}}u(v)&&f(i.TEXTURE_CUBE_MAP),Y.__version=$.version,v.onUpdate&&v.onUpdate(v)}E.__version=v.version}function Q(E,v,I,q,$,Y){const wt=r.convert(I.format,I.colorSpace),lt=r.convert(I.type),St=T(I.internalFormat,wt,lt,I.colorSpace);if(!n.get(v).__hasExternalTextures){const nt=Math.max(1,v.width>>Y),Mt=Math.max(1,v.height>>Y);$===i.TEXTURE_3D||$===i.TEXTURE_2D_ARRAY?e.texImage3D($,Y,St,nt,Mt,v.depth,0,wt,lt,null):e.texImage2D($,Y,St,nt,Mt,0,wt,lt,null)}e.bindFramebuffer(i.FRAMEBUFFER,E),et(v)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,q,$,n.get(I).__webglTexture,0,rt(v)):($===i.TEXTURE_2D||$>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&$<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,q,$,n.get(I).__webglTexture,Y),e.bindFramebuffer(i.FRAMEBUFFER,null)}function yt(E,v,I){if(i.bindRenderbuffer(i.RENDERBUFFER,E),v.depthBuffer){const q=v.depthTexture,$=q&&q.isDepthTexture?q.type:null,Y=y(v.stencilBuffer,$),wt=v.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,lt=rt(v);et(v)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,lt,Y,v.width,v.height):I?i.renderbufferStorageMultisample(i.RENDERBUFFER,lt,Y,v.width,v.height):i.renderbufferStorage(i.RENDERBUFFER,Y,v.width,v.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,wt,i.RENDERBUFFER,E)}else{const q=v.textures;for(let $=0;$<q.length;$++){const Y=q[$],wt=r.convert(Y.format,Y.colorSpace),lt=r.convert(Y.type),St=T(Y.internalFormat,wt,lt,Y.colorSpace),Gt=rt(v);I&&et(v)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,Gt,St,v.width,v.height):et(v)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Gt,St,v.width,v.height):i.renderbufferStorage(i.RENDERBUFFER,St,v.width,v.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function ut(E,v){if(v&&v.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(i.FRAMEBUFFER,E),!(v.depthTexture&&v.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!n.get(v.depthTexture).__webglTexture||v.depthTexture.image.width!==v.width||v.depthTexture.image.height!==v.height)&&(v.depthTexture.image.width=v.width,v.depthTexture.image.height=v.height,v.depthTexture.needsUpdate=!0),X(v.depthTexture,0);const q=n.get(v.depthTexture).__webglTexture,$=rt(v);if(v.depthTexture.format===li)et(v)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,q,0,$):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,q,0);else if(v.depthTexture.format===pi)et(v)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,q,0,$):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,q,0);else throw new Error("Unknown depthTexture format")}function Lt(E){const v=n.get(E),I=E.isWebGLCubeRenderTarget===!0;if(v.__boundDepthTexture!==E.depthTexture){const q=E.depthTexture;if(v.__depthDisposeCallback&&v.__depthDisposeCallback(),q){const $=()=>{delete v.__boundDepthTexture,delete v.__depthDisposeCallback,q.removeEventListener("dispose",$)};q.addEventListener("dispose",$),v.__depthDisposeCallback=$}v.__boundDepthTexture=q}if(E.depthTexture&&!v.__autoAllocateDepthBuffer){if(I)throw new Error("target.depthTexture not supported in Cube render targets");ut(v.__webglFramebuffer,E)}else if(I){v.__webglDepthbuffer=[];for(let q=0;q<6;q++)if(e.bindFramebuffer(i.FRAMEBUFFER,v.__webglFramebuffer[q]),v.__webglDepthbuffer[q]===void 0)v.__webglDepthbuffer[q]=i.createRenderbuffer(),yt(v.__webglDepthbuffer[q],E,!1);else{const $=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Y=v.__webglDepthbuffer[q];i.bindRenderbuffer(i.RENDERBUFFER,Y),i.framebufferRenderbuffer(i.FRAMEBUFFER,$,i.RENDERBUFFER,Y)}}else if(e.bindFramebuffer(i.FRAMEBUFFER,v.__webglFramebuffer),v.__webglDepthbuffer===void 0)v.__webglDepthbuffer=i.createRenderbuffer(),yt(v.__webglDepthbuffer,E,!1);else{const q=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,$=v.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,$),i.framebufferRenderbuffer(i.FRAMEBUFFER,q,i.RENDERBUFFER,$)}e.bindFramebuffer(i.FRAMEBUFFER,null)}function Pt(E,v,I){const q=n.get(E);v!==void 0&&Q(q.__webglFramebuffer,E,E.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),I!==void 0&&Lt(E)}function Ft(E){const v=E.texture,I=n.get(E),q=n.get(v);E.addEventListener("dispose",R);const $=E.textures,Y=E.isWebGLCubeRenderTarget===!0,wt=$.length>1;if(wt||(q.__webglTexture===void 0&&(q.__webglTexture=i.createTexture()),q.__version=v.version,a.memory.textures++),Y){I.__webglFramebuffer=[];for(let lt=0;lt<6;lt++)if(v.mipmaps&&v.mipmaps.length>0){I.__webglFramebuffer[lt]=[];for(let St=0;St<v.mipmaps.length;St++)I.__webglFramebuffer[lt][St]=i.createFramebuffer()}else I.__webglFramebuffer[lt]=i.createFramebuffer()}else{if(v.mipmaps&&v.mipmaps.length>0){I.__webglFramebuffer=[];for(let lt=0;lt<v.mipmaps.length;lt++)I.__webglFramebuffer[lt]=i.createFramebuffer()}else I.__webglFramebuffer=i.createFramebuffer();if(wt)for(let lt=0,St=$.length;lt<St;lt++){const Gt=n.get($[lt]);Gt.__webglTexture===void 0&&(Gt.__webglTexture=i.createTexture(),a.memory.textures++)}if(E.samples>0&&et(E)===!1){I.__webglMultisampledFramebuffer=i.createFramebuffer(),I.__webglColorRenderbuffer=[],e.bindFramebuffer(i.FRAMEBUFFER,I.__webglMultisampledFramebuffer);for(let lt=0;lt<$.length;lt++){const St=$[lt];I.__webglColorRenderbuffer[lt]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,I.__webglColorRenderbuffer[lt]);const Gt=r.convert(St.format,St.colorSpace),nt=r.convert(St.type),Mt=T(St.internalFormat,Gt,nt,St.colorSpace,E.isXRRenderTarget===!0),Ut=rt(E);i.renderbufferStorageMultisample(i.RENDERBUFFER,Ut,Mt,E.width,E.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+lt,i.RENDERBUFFER,I.__webglColorRenderbuffer[lt])}i.bindRenderbuffer(i.RENDERBUFFER,null),E.depthBuffer&&(I.__webglDepthRenderbuffer=i.createRenderbuffer(),yt(I.__webglDepthRenderbuffer,E,!0)),e.bindFramebuffer(i.FRAMEBUFFER,null)}}if(Y){e.bindTexture(i.TEXTURE_CUBE_MAP,q.__webglTexture),H(i.TEXTURE_CUBE_MAP,v);for(let lt=0;lt<6;lt++)if(v.mipmaps&&v.mipmaps.length>0)for(let St=0;St<v.mipmaps.length;St++)Q(I.__webglFramebuffer[lt][St],E,v,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+lt,St);else Q(I.__webglFramebuffer[lt],E,v,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+lt,0);u(v)&&f(i.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(wt){for(let lt=0,St=$.length;lt<St;lt++){const Gt=$[lt],nt=n.get(Gt);e.bindTexture(i.TEXTURE_2D,nt.__webglTexture),H(i.TEXTURE_2D,Gt),Q(I.__webglFramebuffer,E,Gt,i.COLOR_ATTACHMENT0+lt,i.TEXTURE_2D,0),u(Gt)&&f(i.TEXTURE_2D)}e.unbindTexture()}else{let lt=i.TEXTURE_2D;if((E.isWebGL3DRenderTarget||E.isWebGLArrayRenderTarget)&&(lt=E.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(lt,q.__webglTexture),H(lt,v),v.mipmaps&&v.mipmaps.length>0)for(let St=0;St<v.mipmaps.length;St++)Q(I.__webglFramebuffer[St],E,v,i.COLOR_ATTACHMENT0,lt,St);else Q(I.__webglFramebuffer,E,v,i.COLOR_ATTACHMENT0,lt,0);u(v)&&f(lt),e.unbindTexture()}E.depthBuffer&&Lt(E)}function kt(E){const v=E.textures;for(let I=0,q=v.length;I<q;I++){const $=v[I];if(u($)){const Y=E.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:i.TEXTURE_2D,wt=n.get($).__webglTexture;e.bindTexture(Y,wt),f(Y),e.unbindTexture()}}}const Z=[],b=[];function at(E){if(E.samples>0){if(et(E)===!1){const v=E.textures,I=E.width,q=E.height;let $=i.COLOR_BUFFER_BIT;const Y=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,wt=n.get(E),lt=v.length>1;if(lt)for(let St=0;St<v.length;St++)e.bindFramebuffer(i.FRAMEBUFFER,wt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+St,i.RENDERBUFFER,null),e.bindFramebuffer(i.FRAMEBUFFER,wt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+St,i.TEXTURE_2D,null,0);e.bindFramebuffer(i.READ_FRAMEBUFFER,wt.__webglMultisampledFramebuffer),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,wt.__webglFramebuffer);for(let St=0;St<v.length;St++){if(E.resolveDepthBuffer&&(E.depthBuffer&&($|=i.DEPTH_BUFFER_BIT),E.stencilBuffer&&E.resolveStencilBuffer&&($|=i.STENCIL_BUFFER_BIT)),lt){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,wt.__webglColorRenderbuffer[St]);const Gt=n.get(v[St]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Gt,0)}i.blitFramebuffer(0,0,I,q,0,0,I,q,$,i.NEAREST),l===!0&&(Z.length=0,b.length=0,Z.push(i.COLOR_ATTACHMENT0+St),E.depthBuffer&&E.resolveDepthBuffer===!1&&(Z.push(Y),b.push(Y),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,b)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,Z))}if(e.bindFramebuffer(i.READ_FRAMEBUFFER,null),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),lt)for(let St=0;St<v.length;St++){e.bindFramebuffer(i.FRAMEBUFFER,wt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+St,i.RENDERBUFFER,wt.__webglColorRenderbuffer[St]);const Gt=n.get(v[St]).__webglTexture;e.bindFramebuffer(i.FRAMEBUFFER,wt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+St,i.TEXTURE_2D,Gt,0)}e.bindFramebuffer(i.DRAW_FRAMEBUFFER,wt.__webglMultisampledFramebuffer)}else if(E.depthBuffer&&E.resolveDepthBuffer===!1&&l){const v=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[v])}}}function rt(E){return Math.min(s.maxSamples,E.samples)}function et(E){const v=n.get(E);return E.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&v.__useRenderToTexture!==!1}function ot(E){const v=a.render.frame;h.get(E)!==v&&(h.set(E,v),E.update())}function Ct(E,v){const I=E.colorSpace,q=E.format,$=E.type;return E.isCompressedTexture===!0||E.isVideoTexture===!0||I!==En&&I!==_n&&(jt.getTransfer(I)===ne?(q!==Xe||$!==on)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",I)),v}function gt(E){return typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement?(c.width=E.naturalWidth||E.width,c.height=E.naturalHeight||E.height):typeof VideoFrame<"u"&&E instanceof VideoFrame?(c.width=E.displayWidth,c.height=E.displayHeight):(c.width=E.width,c.height=E.height),c}this.allocateTextureUnit=W,this.resetTextureUnits=M,this.setTexture2D=X,this.setTexture2DArray=K,this.setTexture3D=B,this.setTextureCube=j,this.rebindTextures=Pt,this.setupRenderTarget=Ft,this.updateRenderTargetMipmap=kt,this.updateMultisampleRenderTarget=at,this.setupDepthRenderbuffer=Lt,this.setupFrameBufferTexture=Q,this.useMultisampledRTT=et}function zp(i,t){function e(n,s=_n){let r;const a=jt.getTransfer(s);if(n===on)return i.UNSIGNED_BYTE;if(n===ga)return i.UNSIGNED_SHORT_4_4_4_4;if(n===_a)return i.UNSIGNED_SHORT_5_5_5_1;if(n===al)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===sl)return i.BYTE;if(n===rl)return i.SHORT;if(n===Di)return i.UNSIGNED_SHORT;if(n===ma)return i.INT;if(n===Nn)return i.UNSIGNED_INT;if(n===rn)return i.FLOAT;if(n===Fi)return i.HALF_FLOAT;if(n===ol)return i.ALPHA;if(n===ll)return i.RGB;if(n===Xe)return i.RGBA;if(n===cl)return i.LUMINANCE;if(n===hl)return i.LUMINANCE_ALPHA;if(n===li)return i.DEPTH_COMPONENT;if(n===pi)return i.DEPTH_STENCIL;if(n===ul)return i.RED;if(n===va)return i.RED_INTEGER;if(n===dl)return i.RG;if(n===xa)return i.RG_INTEGER;if(n===Sa)return i.RGBA_INTEGER;if(n===ms||n===gs||n===_s||n===vs)if(a===ne)if(r=t.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===ms)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===gs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===_s)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===vs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=t.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===ms)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===gs)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===_s)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===vs)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Or||n===Br||n===zr||n===kr)if(r=t.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===Or)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Br)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===zr)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===kr)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Gr||n===Vr||n===Hr)if(r=t.get("WEBGL_compressed_texture_etc"),r!==null){if(n===Gr||n===Vr)return a===ne?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===Hr)return a===ne?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===Wr||n===Xr||n===qr||n===Yr||n===Kr||n===jr||n===Zr||n===$r||n===Jr||n===Qr||n===ta||n===ea||n===na||n===ia)if(r=t.get("WEBGL_compressed_texture_astc"),r!==null){if(n===Wr)return a===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Xr)return a===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===qr)return a===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Yr)return a===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Kr)return a===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===jr)return a===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Zr)return a===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===$r)return a===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Jr)return a===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Qr)return a===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===ta)return a===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===ea)return a===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===na)return a===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===ia)return a===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===xs||n===sa||n===ra)if(r=t.get("EXT_texture_compression_bptc"),r!==null){if(n===xs)return a===ne?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===sa)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===ra)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===fl||n===aa||n===oa||n===la)if(r=t.get("EXT_texture_compression_rgtc"),r!==null){if(n===xs)return r.COMPRESSED_RED_RGTC1_EXT;if(n===aa)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===oa)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===la)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===fi?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:e}}class kp extends Ae{constructor(t=[]){super(),this.isArrayCamera=!0,this.cameras=t}}class Fe extends ue{constructor(){super(),this.isGroup=!0,this.type="Group"}}const Gp={type:"move"};class gr{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Fe,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Fe,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new A,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new A),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Fe,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new A,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new A),this._grip}dispatchEvent(t){return this._targetRay!==null&&this._targetRay.dispatchEvent(t),this._grip!==null&&this._grip.dispatchEvent(t),this._hand!==null&&this._hand.dispatchEvent(t),this}connect(t){if(t&&t.hand){const e=this._hand;if(e)for(const n of t.hand.values())this._getHandJoint(e,n)}return this.dispatchEvent({type:"connected",data:t}),this}disconnect(t){return this.dispatchEvent({type:"disconnected",data:t}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(t,e,n){let s=null,r=null,a=null;const o=this._targetRay,l=this._grip,c=this._hand;if(t&&e.session.visibilityState!=="visible-blurred"){if(c&&t.hand){a=!0;for(const x of t.hand.values()){const u=e.getJointPose(x,n),f=this._getHandJoint(c,x);u!==null&&(f.matrix.fromArray(u.transform.matrix),f.matrix.decompose(f.position,f.rotation,f.scale),f.matrixWorldNeedsUpdate=!0,f.jointRadius=u.radius),f.visible=u!==null}const h=c.joints["index-finger-tip"],d=c.joints["thumb-tip"],p=h.position.distanceTo(d.position),m=.02,g=.005;c.inputState.pinching&&p>m+g?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:t.handedness,target:this})):!c.inputState.pinching&&p<=m-g&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:t.handedness,target:this}))}else l!==null&&t.gripSpace&&(r=e.getPose(t.gripSpace,n),r!==null&&(l.matrix.fromArray(r.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,r.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(r.linearVelocity)):l.hasLinearVelocity=!1,r.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(r.angularVelocity)):l.hasAngularVelocity=!1));o!==null&&(s=e.getPose(t.targetRaySpace,n),s===null&&r!==null&&(s=r),s!==null&&(o.matrix.fromArray(s.transform.matrix),o.matrix.decompose(o.position,o.rotation,o.scale),o.matrixWorldNeedsUpdate=!0,s.linearVelocity?(o.hasLinearVelocity=!0,o.linearVelocity.copy(s.linearVelocity)):o.hasLinearVelocity=!1,s.angularVelocity?(o.hasAngularVelocity=!0,o.angularVelocity.copy(s.angularVelocity)):o.hasAngularVelocity=!1,this.dispatchEvent(Gp)))}return o!==null&&(o.visible=s!==null),l!==null&&(l.visible=r!==null),c!==null&&(c.visible=a!==null),this}_getHandJoint(t,e){if(t.joints[e.jointName]===void 0){const n=new Fe;n.matrixAutoUpdate=!1,n.visible=!1,t.joints[e.jointName]=n,t.add(n)}return t.joints[e.jointName]}}const Vp=`
void main() {
